...
class ParagraphSentencer {
	...
	public static List<Animation> sentencesToNodeInfo(Graph graph, List<Node> realNodes, List<String> sentences) {
		...
		for (int i = 0; i < sentences.size(); i++) {
			...
			for (int q = 0; q < sentences.get(i).length(); q++) {
				...
				for (int j = 0; j < letterEdges.size(); j++) {
					letterEdges.get(j).setLocation(letterEdges.get(j).getX() + nodes.size(),
							letterEdges.get(j).getY() + nodes.size());
					/*
					 * System.out.print("From: "); System.out.print(letterEdges.get(j).getX());
					 * System.out.print(" -> "); System.out.println(letterEdges.get(j).getY());
					 */
				}
		...
		for (int i = 0; i < sentenceNodes.size(); i++) {
			...
			// System.out.println("sentenceNodes[" + Integer.toString(i) + "] size: " +
			// Integer.toString(sentenceNodes.get(i).size()) );
		...
		for (int i = 0; i < realNodes.size(); i++) {
			...
			for (int j = 0; j < sentences.size(); j++) {
				colourPoints
						.add(new ColorTimePoint(jTime + nodeDelay * i, TestRainbowAlgorithm.CalcRainbowColour(input)));
				jTime += pauseTime;
				colourPoints
						.add(new ColorTimePoint(jTime + nodeDelay * i, TestRainbowAlgorithm.CalcRainbowColour(input)));
			...
			for (int j = i; j < realNodes.size(); j++) {
				...
				for (int q = 0; q < sentenceEdges.size(); q++) {
					...
					for (int p = 0; p < sentenceEdges.get(q).size(); p++) {
						if ((sentenceEdges.get(q).get(p).getX() == i && sentenceEdges.get(q).get(p).getY() == j)
								|| (sentenceEdges.get(q).get(p).getY() == i
										&& sentenceEdges.get(q).get(p).getX() == j)) {
							/*
							 * System.out.println("Found (" +
							 * Integer.toString(sentenceEdges.get(q).get(p).getX()) + ", " +
							 * sentenceEdges.get(q).get(p).getY() + ") with (" + Integer.toString(i) + ", "
							 * + Integer.toString(j) + ")");
							 */isHidden = false;
							oneEdgeVis = true;
							break;
					...
					edgeVisibility
							.add(new BooleanTimePoint(currentTime + nodeDelay * i - transitionTime / 2.0, isHidden));
			...
			animations.add(
					new Position2DAnimation(realNodes.get(i), posPoints, posPoints.get(posPoints.size() - 1).getTime(),
							0, 1, new StandardLooper(), new SigmoidInterpolator()));
			animations.add(new FillColorAnimation(realNodes.get(i), colourPoints,
					posPoints.get(posPoints.size() - 1).getTime(), 0, 1, new StandardLooper(),
...
class LetterA extends Letter {
	public LetterA() {
		nodes = new Point2D.Double[] { new Point2D.Double(0, 1), new Point2D.Double(0.2, 2.0 / 3.0),
				new Point2D.Double(0.5, 0), new Point2D.Double(0.8, 2.0 / 3.0), new Point2D.Double(1, 1) };
...
class LetterCoil extends Letter {
	public LetterCoil() {
		nodes = new Point2D.Double[] { new Point2D.Double(0, 1), new Point2D.Double(0, 1), new Point2D.Double(0, 1),
				new Point2D.Double(0, 1), new Point2D.Double(0, 1), new Point2D.Double(0, 1), new Point2D.Double(0, 1),
				new Point2D.Double(0, 1), new Point2D.Double(0, 1), new Point2D.Double(0, 1), new Point2D.Double(0, 1),
				new Point2D.Double(0, 1), new Point2D.Double(0, 1), new Point2D.Double(0, 1),
...
class LetterB extends Letter {
	public LetterB() {
		nodes = new Point2D.Double[] { new Point2D.Double(0, 1), new Point2D.Double(0, 0), new Point2D.Double(1, 0.25),
				new Point2D.Double(1.0 / 3.0, 0.5), new Point2D.Double(1, 0.75), new Point2D.Double(2.0 / 3.0, 1) };
...
class LetterC extends Letter {
	public LetterC() {
		nodes = new Point2D.Double[] { new Point2D.Double(1, 0.1), new Point2D.Double(0.5, 0),
				new Point2D.Double(0, 0.5), new Point2D.Double(0.5, 1), new Point2D.Double(1, 0.9) };
...
class LetterE extends Letter {
	public LetterE() {
		nodes = new Point2D.Double[] { new Point2D.Double(1, 0), new Point2D.Double(0, 0), new Point2D.Double(0, 0.5),
				new Point2D.Double(1, 0.5), new Point2D.Double(0, 1), new Point2D.Double(1, 1) };
...
class LetterF extends Letter {
	public LetterF() {
		nodes = new Point2D.Double[] { new Point2D.Double(1, 0), new Point2D.Double(0, 0), new Point2D.Double(0, 0.5),
				new Point2D.Double(0, 1), new Point2D.Double(1, 0.5) };
...
class LetterG extends Letter {
	public LetterG() {
		nodes = new Point2D.Double[] { new Point2D.Double(1, 0.1), new Point2D.Double(0.5, 0),
				new Point2D.Double(0, 0.5), new Point2D.Double(0.5, 1), new Point2D.Double(1, 0.9),
				new Point2D.Double(1, 0.5), new Point2D.Double(0.5, 0.5) };
		edges = new Point[] { new Point(0, 1), new Point(1, 2), new Point(2, 3), new Point(3, 4), new Point(4, 5),
				new Point(5, 6) };
	}
}
...
class LetterH extends Letter {
	public LetterH() {
		nodes = new Point2D.Double[] { new Point2D.Double(0, 0), new Point2D.Double(0, 0.5), new Point2D.Double(1, 0.5),
				new Point2D.Double(1, 1), new Point2D.Double(1, 0), new Point2D.Double(0, 1) };
...
class LetterJ extends Letter {
	public LetterJ() {
		nodes = new Point2D.Double[] { new Point2D.Double(0, 0.9), new Point2D.Double(0.5, 1),
				new Point2D.Double(1, 0.9), new Point2D.Double(1, 0) };
...
class LetterK extends Letter {
	public LetterK() {
		nodes = new Point2D.Double[] { new Point2D.Double(0, 0), new Point2D.Double(0, 0.5), new Point2D.Double(1, 1),
				new Point2D.Double(1, 0), new Point2D.Double(0, 1) };
...
class LetterM extends Letter {
	public LetterM() {
		width = 1.5;
		nodes = new Point2D.Double[] { new Point2D.Double(0, 1), new Point2D.Double(0, 0), new Point2D.Double(0.5, 1),
...
class LetterN extends Letter {
	public LetterN() {
		nodes = new Point2D.Double[] { new Point2D.Double(0, 1), new Point2D.Double(0, 0), new Point2D.Double(1, 1),
...
class LetterO extends Letter {
	public LetterO() {
		nodes = new Point2D.Double[] { new Point2D.Double(0, 0.5), new Point2D.Double(0.5, 0),
				new Point2D.Double(1, 0.5), new Point2D.Double(0.5, 1) };
...
class LetterP extends Letter {
	public LetterP() {
		nodes = new Point2D.Double[] { new Point2D.Double(0, 1), new Point2D.Double(0, 0.5), new Point2D.Double(0, 0),
				new Point2D.Double(1, 0.25) };
...
class LetterQ extends Letter {
	public LetterQ() {
		nodes = new Point2D.Double[] { new Point2D.Double(0, 0.5), new Point2D.Double(0.5, 0),
				new Point2D.Double(1, 0.5), new Point2D.Double(5.0 / 6.0, 5.5 / 6.0), new Point2D.Double(0.5, 1),
				new Point2D.Double(1 + 1.0 / 7.0, 1 + 1.0 + 1.0 / 6.0) };
...
class LetterR extends Letter {
	public LetterR() {
		nodes = new Point2D.Double[] { new Point2D.Double(0, 1), new Point2D.Double(0, 0), new Point2D.Double(1, 0.25),
				new Point2D.Double(0, 0.5), new Point2D.Double(1, 1) };
		edges = new Point[] { new Point(0, 1), new Point(1, 2), new Point(2, 3), new Point(3, 4) };
	}
}
...
class LetterS extends Letter {
	public LetterS() {
		nodes = new Point2D.Double[] { new Point2D.Double(1.0, 0.1), new Point2D.Double(0.5, 0),
				new Point2D.Double(0, 0.25), new Point2D.Double(1, 0.75), new Point2D.Double(0.5, 1),
				new Point2D.Double(0, 0.9) };
		edges = new Point[] { new Point(0, 1), new Point(1, 2), new Point(2, 3), new Point(3, 4), new Point(4, 5) };
	}
}
...
class LetterT extends Letter {
	public LetterT() {
		nodes = new Point2D.Double[] { new Point2D.Double(0, 0), new Point2D.Double(0.5, 0), new Point2D.Double(1, 0),
...
class LetterU extends Letter {
	public LetterU() {
		nodes = new Point2D.Double[] { new Point2D.Double(0, 0), new Point2D.Double(0, 2.0 / 3.0),
				new Point2D.Double(0.5, 1), new Point2D.Double(1, 2.0 / 3.0), new Point2D.Double(1, 0) };
		edges = new Point[] { new Point(0, 1), new Point(1, 2), new Point(2, 3), new Point(3, 4) };
	}
}
...
class LetterW extends Letter {
	public LetterW() {
		width = 1.5;
		nodes = new Point2D.Double[] { new Point2D.Double(0, 0), new Point2D.Double(0.25, 1),
				new Point2D.Double(0.5, 0), new Point2D.Double(0.75, 1), new Point2D.Double(1, 0) };
		edges = new Point[] { new Point(0, 1), new Point(1, 2), new Point(2, 3), new Point(3, 4) };
	}
}
...
class LetterX extends Letter {
	public LetterX() {
		nodes = new Point2D.Double[] { new Point2D.Double(0, 0), new Point2D.Double(0.5, 0.5), new Point2D.Double(1, 0),
...
class LetterZ extends Letter {
	public LetterZ() {
		nodes = new Point2D.Double[] { new Point2D.Double(0, 0), new Point2D.Double(1, 0), new Point2D.Double(0, 1),
