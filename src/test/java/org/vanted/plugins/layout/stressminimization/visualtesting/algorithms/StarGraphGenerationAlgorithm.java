...
/**
 * Generates star graphs with a certain number of nodes
 */
public class StarGraphGenerationAlgorithm extends AbstractAlgorithm {
    ...
    public String getName() {
        return "Generate star graphs";
    }

    @Override
    public String getDescription() {
        return "Generate a star graph with a certain number of nodes";
    }
    ...
    public void execute() {
        ...
        BackgroundTaskHelper.issueSimpleTask("Generating star graph", "Generating star graph", new Runnable() {
            @Override
            public void run() {
                try {
                    GraphGeneration gen = new GraphGeneration();
                    Graph graph = gen.generateStar(numberOfNodes);
