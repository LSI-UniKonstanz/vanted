...
public class TestPlugin extends IPK_PluginAdapter {
	...
	public TestPlugin() {
		...
		this.algorithms = new Algorithm[] { new HammingDistanceAlgorithm(), new TestAlgorithm(), new TestAlgorithm2() };
		
		this.views = new String[] { TestViewWithPreferences.class.getName() };
	}
