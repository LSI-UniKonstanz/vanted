 ...
 * {@link #addFileDropTarget addFileDropTarget(...)} method. If the component is
 * a {@link java.awt.Container}, then all elements contained within will be
 * marked as a drop target as well. Using the {@link FileDrop} technique
...
public class FileDropBean implements java.io.Serializable {
	 ...
	 * only the outer container will change borders during a drag and drop operation
