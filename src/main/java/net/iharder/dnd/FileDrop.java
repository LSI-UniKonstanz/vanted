...
public class FileDrop {
	...
	public FileDrop(final java.awt.Component c, final Listener listener, final Runnable dropDetected,
			final Runnable dropEndDetected) {
		this(null, // Logging stream
				c, // Drop target
				javax.swing.BorderFactory.createMatteBorder(2, 2, 2, 2, defaultBorderColor), // Drag border
				true, // Recursive
	...
	public FileDrop(final java.awt.Component c, final javax.swing.border.Border dragBorder, final boolean recursive,
			final Listener listener) {
		this(null, c, dragBorder, recursive, listener, null, null);
	} // end constructor
	...
	public FileDrop(final java.io.PrintStream out, final java.awt.Component c,
			...
			final Runnable dropDetected, final Runnable dropEndDetected) {
			...
			dropListener = new java.awt.dnd.DropTargetListener() {
				public void dragEnter(java.awt.dnd.DropTargetDragEvent evt) {
					...
					if (isDragOk(out, evt)) {
						...
						if (dropDetected != null)
							SwingUtilities.invokeLater(dropDetected);
					} // end if: drag ok
				...
				public void drop(java.awt.dnd.DropTargetDropEvent evt) {
					...
					try { // Get whatever was dropped
						...
						if (dropEndDetected != null)
							SwingUtilities.invokeLater(dropEndDetected);
					} // end finally
				} // end drop
