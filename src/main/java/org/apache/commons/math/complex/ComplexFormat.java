...
public class ComplexFormat extends Format implements Serializable {
	...
	/**
	 * Formats a object to produce a string. <code>obj</code> must be either a {@link Complex} object or a {@link Number} object. Any other type of
	...
	/**
	 * Create a default number format. The default number format is based on {@link NumberFormat#getInstance()} with the only customizing is the
	 ...
	 *           the string to parse
	 * @param pos
	 *           input/ouput parsing parameter. On output, <code>pos</code> holds the index of the next non-whitespace character.
	 */
	 ...
	 * @throws IllegalArgumentException
	 *            if <code>imaginaryCharacter</code> is <code>null</code> or an empty string.
	 */
	 ...
	 * @throws IllegalArgumentException
	 *            if <code>imaginaryFormat</code> is <code>null</code>.
	 */
	 ...
	 * @throws IllegalArgumentException
	 *            if <code>realFormat</code> is <code>null</code>.
	 */
