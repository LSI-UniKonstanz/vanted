...
/**
 * Static implementations of common {@link org.apache.commons.math.complex.Complex}-valued functions. Included
 * are trigonometric, exponential, log, power and square root functions.
 *<p>
 * Reference:
 * <ul>
 * <li><a href="http://myweb.lmu.edu/dmsmith/ZMLIB.pdf"> Multiple Precision Complex Arithmetic and Functions</a></li>
 * </ul>
 * See individual method javadocs for the computational formulas used. In general, NaN values in either real or imaginary parts of input arguments result in
 * {@link Complex#NaN} returned. Otherwise, infinite or NaN values are returned as they arise in computing the real functions specified in the computational
 * formulas. Null arguments result in NullPointerExceptions.
 * 
 * @version $Revision: 1.2 $ $Date: 2010/12/14 07:02:09 $
 */
public class ComplexUtils {
	 ...
	 * </pre>
	 * <p>
	 * Returns {@link Complex#NaN} if either real or imaginary part of the input argument is <code>NaN</code> or infinite.
	 * 
	 * @param z
	 ...
	 * </pre>
	 * 
	 * where the (real) functions on the right-hand side are {@link java.lang.Math#sin}, {@link java.lang.Math#cos}, {@link MathUtils#cosh} and
	 * {@link MathUtils#sinh}.
	 * <p>
	 * Returns {@link Complex#NaN} if either real or imaginary part of the input argument is <code>NaN</code>.
	 * <p>
	 ...
	 * </pre>
	 * 
	 * where ln on the right hand side is {@link java.lang.Math#log}, <code>|a + bi|</code> is the modulus, {@link Complex#abs}, and
	 ...
	 * <p>
	 * The value returned is <code>r&middot;e<sup>i&middot;theta</sup></code>, computed as <code>r&middot;cos(theta) + r&middot;sin(theta)i</code>
	 * <p>
	 * If either <code>r</code> or <code>theta</code> is NaN, or <code>theta</code> is infinite, {@link Complex#NaN} is returned.
	 * <p>
	 * If <code>r</code> is infinite and <code>theta</code> is finite, infinite or NaN values may be returned in parts of the result, following the rules for
	 * double arithmetic.
	 * 
	 * <pre>
	 * Examples: 
	 ...
	 * <p>
	 * Returns {@link Complex#NaN} if either real or imaginary part of the input argument is <code>NaN</code> or infinite, or if <code>y</code> equals
	 * {@link Complex#ZERO}.
	 * 
	 * @param y
	 *           the base.
	 ...
	 * sinh(&plusmn;INFINITY &plusmn; INFINITY i) = NaN + NaN i</code>
	 * </pre
	 * 
	 * @param z
	 ...
	 * argument.
	 * <p>
	 * Computes the result directly as <code>sqrt(Complex.ONE.subtract(z.multiply(z)))</code>.
	 * <p>
	 * Returns {@link Complex#NaN} if either real or imaginary part of the input argument is <code>NaN</code>.
	 * <p>
	 * Infinite values in real or imaginary parts of the input may result in infinite or NaN values returned in parts of the result.
