 ...
 * 
 * @since 1.1
 * @version $Revision: 1.3 $ $Date: 2010/12/14 07:02:08 $
 */
public class Fraction extends Number implements Comparable {
	 ...
	 *           the double value to convert to a fraction.
	 * @param epsilon
	 *           maximum error allowed. The resulting fraction is within <code>epsilon</code> of <code>value</code>, in absolute terms.
	 * @param maxIterations
	 ...
	 *            if the denomiator is <code>zero</code>
	 */
