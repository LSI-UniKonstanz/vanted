...
public class FractionFormat extends Format implements Serializable {
	...
	/**
	 * Formats a object to produce a string. <code>obj</code> must be either a {@link Fraction} object or a {@link Number} object. Any other type of
	 ...
	 * @throws IllegalArgumentException
	 *            if <code>format</code> is <code>null</code>.
	 */
