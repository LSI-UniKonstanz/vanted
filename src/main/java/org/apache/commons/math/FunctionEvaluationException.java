 ...
 * <p>
 * Maintains an <code>argument</code> property holding the input value that caused the function evaluation to fail.
 * 
...
public class FunctionEvaluationException extends MathException {
	 ...
	 * text. The message text of the exception will start with <code>message</code> and be followed by
	 ...
	 * The message text of the exception will start with <code>message</code> and be followed by " Evaluation failed for argument = " + argument.
	 * 
	 * @param argument
	 *           the failing function argument
	 * @param message
