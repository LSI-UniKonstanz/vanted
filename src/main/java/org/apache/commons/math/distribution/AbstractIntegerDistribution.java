...
public abstract class AbstractIntegerDistribution extends AbstractDistribution
	 ...
	 * <p>
	 * If <code>x</code> does not represent an integer value, the CDF is evaluated at the greatest integer less than x.
	 * 
	 * @param x
	 ...
	 * bracket a PDF root. This method is used by {@link #inverseCumulativeProbability(double)} to find critical values.
	 * 
	 * @param p
