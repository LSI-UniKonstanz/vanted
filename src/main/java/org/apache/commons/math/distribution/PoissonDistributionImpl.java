...
public class PoissonDistributionImpl extends AbstractIntegerDistribution
	 ...
	 * The mean value must be positive; otherwise an <code>IllegalArgument</code> is thrown.
	 * 
	 * @param p
	 *           the Poisson mean
	 ...
	 * approximation. The <code>N(mean, sqrt(mean))</code> distribution is used to approximate the Poisson distribution.
	 * <p>
	 * The computation uses "half-correction" -- evaluating the normal distribution function at <code>x + 0.5</code>
	 * 
	 * @param x
	 ...
	 * bracket a CDF root. This method is used by {@link #inverseCumulativeProbability(double)} to find critical values.
	 * 
	 * @param p
