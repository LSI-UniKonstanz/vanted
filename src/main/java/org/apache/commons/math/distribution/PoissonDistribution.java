 ...
 * References:
 * <ul>
 * <li><a href="http://mathworld.wolfram.com/PoissonDistribution.html"> Poisson distribution</a></li>
 * </ul>
 * </p>
 * 
...
public interface PoissonDistribution extends IntegerDistribution {
	 ...
	 * The parameter value must be positive; otherwise an <code>IllegalArgument</code> is thrown.
	 * 
	 * @param p
	 *           the mean
