 ...
 * <p>
 * All data generation methods are based on <code>nextDouble().</code> Concrete implementations <strong>must</strong> override this method and
 * <strong>should</strong> provide better / more performant implementations of the other methods if the underlying PRNG supplies them.
 * 
 * @since 1.1
...
public abstract class AbstractRandomGenerator implements RandomGenerator {
	...
	/**
	 * Clears the cache used by the default implementation of {@link #nextGaussian}. Implemementations that do not override the
	 ...
	 * <p>
	 * Implementations that do not override the default implementation of <code>nextGaussian</code> should include a call to {@link #clear} in the implementation
	 * of this method.
	 * 
	 * @param seed
	 *           the seed value
	 ...
	 * <p>
	 * The default implementation uses the <em>Polar Method</em> due to G.E.P. Box, M.E. Muller and G. Marsaglia, as described in D. Knuth, <u>The Art of
	 * Computer Programming</u>, 3.4.1C.
	 * <p>
	 * The algorithm generates a pair of independent random values. One of these is cached for reuse, so the full algorithm is not executed on each activation.
	 * Implementations that do not override this method should make sure to call {@link #clear} to clear the cached value in the implementation of
	 * {@link #setSeed(long)}.
	 * 
