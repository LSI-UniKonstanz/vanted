...
public class ValueServer {
	 ...
	 * <p>
	 * This method must be called before using <code>getNext()</code> with <code>mode = DISGEST_MODE</code>
	 * 
	 * @throws IOException
	 ...
	 * <ul>
	 * <li>Before this method is called, <code>computeDistribution()</code> must have completed successfully; otherwise an <code>IllegalStateException</code>
	 * will be thrown</li>
	 * </ul>
	 * 
