 ...
 * <p>
 * Provides a default implementation of <code>evaluate(double[]),</code> delegating to <code>evaluate(double[], int, int)</code> in the natural way.
 * <p>
 * Also includes a <code>test</code> method that performs generic parameter validation for the <code>evaluate</code> methods.
 * <p>
 * 
