 ...
 * <p>
 * <strong>Note that this implementation is not synchronized.</strong> If multiple threads access an instance of this class concurrently, and at least one of
 * the threads invokes the <code>increment()</code> or <code>clear()</code> method, it must be synchronized externally.
 * 
...
public class StandardDeviation extends AbstractStorelessUnivariateStatistic
	...
	/**
	 * Contructs a StandardDeviation with the specified value for the <code>isBiasCorrected</code> property. If this property is set to <code>true</code>, the
	 * {@link Variance} used in computing results will
	...
	/**
	 * Contructs a StandardDeviation with the specified value for the <code>isBiasCorrected</code> property and the supplied external moment.
