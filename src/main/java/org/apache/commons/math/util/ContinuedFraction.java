...
public abstract class ContinuedFraction implements Serializable {
	 ...
	 * <ul>
	 * <li>Eric W. Weisstein. "Continued Fraction." From MathWorld--A Wolfram Web Resource. <a target="_blank"
	 * href="http://mathworld.wolfram.com/ContinuedFraction.html"> http://mathworld.wolfram.com/ContinuedFraction.html</a></li>
	 * </ul>
	 * The recurrence relationship defined in those equations can result in very large intermediate results which can result in numerical overflow. As a means to
	 * combat these overflow conditions, the intermediate results are scaled whenever they threaten to become numerically unstable.
	 * 
	 * @param x
	 *           the evaluation point.
	 * @param epsilon
