...
public interface UnivariateRealSolver {
	 ...
	 * <p>
	 * Usually a high iteration count indicates convergence problems. However, the "reasonable value" varies widely for different solvers. Users are advised to
	 * use the default value supplied by the solver.
	 * <p>
	 * A <code>ConvergenceException</code> will be thrown if this number is exceeded.
	 * 
	 * @param count
	 ...
	 * <p>
	 * The default is usually choosen so that roots in the interval -10..-0.1 and +0.1..+10 can be found with a reasonable accuracy. If the expected absolute
	 * value of your roots is of much smaller magnitude, set this to a smaller value.
	 * <p>
	 ...
	 * <p>
	 * This is mainly meant for testing purposes. It may occasionally help track down performance problems: if the iteration count is notoriously high, check
	 * whether the function is evaluated properly, and whether another solver is more amenable to the problem.
	 * 
