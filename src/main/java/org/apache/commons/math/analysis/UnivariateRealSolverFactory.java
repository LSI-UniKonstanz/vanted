 ...
 * <li>Secant method</li>
 * </ul>
 * Concrete factories extending this class also specify a default solver, instances of which are returned by <code>newDefaultSolver()</code>.
 * <p>
 * Common usage:
 * 
 * <pre>
 ...
 * </pre>
 * 
 * <a href="http://jakarta.apache.org/commons/discovery/">Jakarta Commons Discovery</a> is used to determine the concrete factory returned by
 * <code>UnivariateRealSolverFactory.newInstance().</code> The default is {@link UnivariateRealSolverFactoryImpl}.
 * 
