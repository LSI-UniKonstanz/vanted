...
public class BrentSolver extends UnivariateRealSolverImpl {
	 ...
	 * <p>
	 * Throws <code>ConvergenceException</code> if the values of the function at the endpoints of the interval have the same sign.
	 * 
	 * @param min
	 ...
	 * Find a zero in the given interval.
	 * <p>
	 * Requires that the values of the function at the endpoints have opposite signs. An <code>IllegalArgumentException</code> is thrown if this is not the case.
	 * 
	 * @param min
	 *           the lower bound for the interval.
	 * @param max
