...
public class Beta implements Serializable {
	 ...
	 * <ul>
	 * <li><a href="http://mathworld.wolfram.com/RegularizedBetaFunction.html"> Regularized Beta Function</a>.</li>
	 * <li><a href="http://functions.wolfram.com/06.21.10.0001.01"> Regularized Beta Function</a>.</li>
	 * </ul>
	 * 
	 * @param x
	 *           the value.
	 ...
	 * The implementation of this method is based on:
	 * <ul>
	 * <li><a href="http://mathworld.wolfram.com/BetaFunction.html"> Beta Function</a>, equation (1).</li>
	 * </ul>
	 * 
	 * @param a
	 *           the a parameter.
