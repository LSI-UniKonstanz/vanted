...
/**
 * Handles command line parameters to configure the <tt>SVGConverter</tt> and rasterizer images. <br />
 * Each command line option is handled by an <tt>OptionHandler</tt> which
 * is responsible for converting the option into a configuration of the <tt>SVGConverter</tt> which is used to perform the conversion.
 * 
 * @author <a href="mailto:vhardy@apache.org">Vincent Hardy</a>
 * @version $Id: Main.java,v 1.2 2010/12/14 07:02:06 morla Exp $
 */
public class Main implements SVGConverterController {
	...
	public static interface OptionHandler {
		/**
		 * The <tt>OptionHandler</tt> should configure the <tt>SVGConverter</tt> according to the value of the option.
	 ...
	 * throws an exception if the number of arguments passed to the <tt>handleOption</tt> method does not match the number of expected
	 * optionValues. If the size matches, the <tt>safeHandleOption</tt> method is invoked.
	 ...
	 * the <tt>handleOption</tt> method which takes only an <tt>SVGConverter</tt> as a parameter.
	 */
	 ...
	 * be a float. Subclasses should implement the <tt>handleOption</tt> method which takes a float and an <tt>SVGConverter</tt> as
	 * parameters.
	 */
