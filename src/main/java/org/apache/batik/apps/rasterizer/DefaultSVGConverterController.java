...
/**
 * Default controller for the <tt>SVGConverter</tt> operation.
 * 
 * @author <a href="mailto:vhardy@apache.org">Vincent Hardy</a>
 * @version $Id: DefaultSVGConverterController.java,v 1.2 2010/12/14 07:02:06 morla Exp $
 */
public class DefaultSVGConverterController implements SVGConverterController {
	 ...
	 * 
	 * @param transcoder
	 *           Transcoder which will be used for the conversion
	 * @param hints
