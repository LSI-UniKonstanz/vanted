...
public enum AlignmentSetting {
	HIDDEN, AUTO_OUTSIDE, BELOW, ABOVE, RIGHT, LEFT, INSIDEBOTTOM, INSIDETOP, INSIDETOPLEFT, INSIDETOPRIGHT, INSIDEBOTTOMLEFT, INSIDEBOTTOMRIGHT, INSIDELEFT, INSIDERIGHT, CENTERED, BELOWRIGHT, BELOWLEFT, ABOVELEFT, ABOVERIGHT, NEARSOURCE, NEARTARGET, BORDER_TOP_LEFT, BORDER_TOP_CENTER, BORDER_TOP_RIGHT, BORDER_BOTTOM_LEFT, BORDER_BOTTOM_CENTER, BORDER_BOTTOM_RIGHT, BORDER_LEFT_TOP, BORDER_LEFT_CENTER, BORDER_LEFT_BOTTOM, BORDER_RIGHT_TOP, BORDER_RIGHT_CENTER, BORDER_RIGHT_BOTTOM;
