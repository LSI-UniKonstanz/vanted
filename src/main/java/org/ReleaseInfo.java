...
public class ReleaseInfo implements HelperClass {
	 ...
	 */
	public static synchronized String getOldVersionIfAppHasBeenUpdated(String currentVersion) {
		synchronized (ReleaseInfo.class) {
			...
			if (oldVersion != null && oldVersion.length() > 0 && !oldVersion.equalsIgnoreCase(currentVersion))
