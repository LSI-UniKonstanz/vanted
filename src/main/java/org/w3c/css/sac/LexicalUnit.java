 ...
 * $Id: LexicalUnit.java,v 1.2 2010/12/14 07:02:03 morla Exp $
 */
 ...
 * <p>
 * <b>Remarks</b>: Not all the following lexical units are supported (or will be supported) by CSS.
 * <p>
...
public interface LexicalUnit {
	 ...
	 * <p>
	 * If the type of <code>LexicalUnit</code> is one of SAC_DEGREE, SAC_GRADIAN, SAC_RADIAN, SAC_MILLISECOND, SAC_SECOND, SAC_HERTZ or SAC_KILOHERTZ, the value
	...
	/**
	 * The function parameters including operators (like the comma). <code>#000</code> is converted to <code>rgb(0, 0, 0)</code> can return <code>null</code> if
	 * <code>SAC_FUNCTION</code>.
	 * 
	 * @see #SAC_COUNTER_FUNCTION
	 * @see #SAC_COUNTERS_FUNCTION
	 * @see #SAC_RECT_FUNCTION
	 ...
	 * <p>
	 * If the type is <code>SAC_URI</code>, the return value doesn't contain <code>uri(....)</code> or quotes.
	 * <p>
	 * If the type is <code>SAC_ATTR</code>, the return value doesn't contain <code>attr(....)</code>.
	 * 
	 * @see #SAC_URI
	 * @see #SAC_ATTR
	 * @see #SAC_IDENT
