 ...
 * $Id: SelectorFactory.java,v 1.2 2010/12/14 07:02:03 morla Exp $
 */
...
public interface SelectorFactory {
	 ...
	 * 
	 * @param namespaceURI
	 *           the <a href="http://www.w3.org/TR/REC-xml-names/#dt-NSName">namespace
	 *           URI</a> of the element selector.
	 * @param tagName
	 *           the <a href="http://www.w3.org/TR/REC-xml-names/#NT-LocalPart">local
	 ...
	 *               If this selector is not supported.
	 */
	ProcessingInstructionSelector createProcessingInstructionSelector(String target,
							String data)
						throws CSSException;
	 ...
	 * 
	 * @param pseudoName
	 *           the pseudo element name. <code>NULL</code> if this
