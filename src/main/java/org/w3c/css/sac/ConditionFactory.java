 ...
 * $Id: ConditionFactory.java,v 1.2 2010/12/14 07:02:03 morla Exp $
 */
...
public interface ConditionFactory {
	 ...
	 * @param typeNode
	 *           <code>true</code> if the list should contain
	 *           only nodes of the same type (element, text node, ...).
	 * @param type
	 *           <code>true</code> true if the list should contain
	 ...
	 * @param specified
	 *           <code>true</code> if the attribute must be specified
	 *           in the document.
	 * @param value
