 ...
 * $Id: CSSParseException.java,v 1.2 2010/12/14 07:02:03 morla Exp $
 */
 ...
 * <p>
 * This exception will include information for locating the error in the original CSS document. Note that although the application will receive a
 * CSSParseException as the argument to the handlers in the ErrorHandler interface, the application is not actually required to throw the exception; instead, it
 * can simply read the information in it and take a different action.
 * </p>
 * <p>
...
public class CSSParseException extends CSSException {
	 ...
	 * <p>
	 * This constructor is especially useful when an application is creating its own exception from within a DocumentHandler callback, and needs to wrap an
	 * existing exception that is not a subclass of CSSException.
	 * </p>
	 * 
	 * @param message
	 ...
	 * @param uri
	 *           The URI of the document that generated
