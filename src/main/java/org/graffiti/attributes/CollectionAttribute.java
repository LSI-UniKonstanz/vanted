...
public interface CollectionAttribute extends DeepCopy, Attribute {
	 ...
	 */
	public Attribute getAttribute(String path) throws AttributeNotFoundException, NoCollectionAttributeException;
	...
	/**
	 * Returns <code>true</code> if the <code>CollectionAttribute</code> is empty.
	 * 
	...
	/**
	 * Adds a given <code>Attribute</code> to the list. The id of given attribute
	 * may not be already in the list.
	 * 
	 * @param att
	 *           the new attribute to add to the list.
	 * @exception AttributeExistsException
	 *               if there is already an attribute with the same id as the given
	 *               attribute.
	 */
	public void add(Attribute att) throws AttributeExistsException, FieldAlreadySetException;
	...
	/**
	 * Removes the <code>Attribute</code> with the given <code>id</code> from the
	 * list.
	 * 
	 * @param id
