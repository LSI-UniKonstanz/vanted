...
public class BooleanAttribute extends AbstractAttribute {
	...
	/**
	 * Constructs a new instance of a <code>BooleanAttribute</code> with the given
	 * value.
	 * 
	 * @param id
	 *            the id of the attribute.
	...
	/**
	 * Returns a deep copy of this instance. Parent won't be set because the context
	 * may be different.
	 * 
	 ...
	 * implicitly by the method <code>setValue()</code>.
	 * 
	 * @param o
