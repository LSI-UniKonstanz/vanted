...
public interface Attributable {
	 ...
	 * <code>Attribute</code> is created at the given location, if it does not yet
	 * exist.
	 * 
	 * @param path
	 ...
	 * </p>
	 * <p>
	 * Given there already exists an <code>Attribute</code> with the same <code>id</code> and cannot be overwritten,
	 * then an <code>AttributeExistsException</code> will be thrown.
	 * </p>
	 * 
	 * @param attr
	 *           the <code>Attribute</code> to be added.
	 * @exception AttributeExistsException
	 *               if there is already an <code>Attribute</code> with the same
	 *               <code>id</code> as <code>attr</code> at location
	 *               <code>path</code>.
	 * @exception NoCollectionAttributeException
	 *               if the <code>Attribute</code> at location <code>path</code> is
	 *               not a <code>CollectionAttribute</code>.
	 */
	 ...
	 * @exception AttributeExistsException
	 *               if there is already an <code>Attribute</code> with the given
	...
	/**
	 * Adds a <code>DoubleAttribute</code> with the given value and <code>id</code>
	 * to a <code>CollectionAttribute</code> at <code>path</code>.
	 * 
	 * @param path
	 *           the path to the <code>CollectionAttribute</code> the new
	...
	/**
	 * Adds a <code>FloatAttribute</code> with the given value and <code>id</code>
	 * to a <code>CollectionAttribute</code> at <code>path</code>.
	 * 
	 * @param path
	 *           the path to the <code>CollectionAttribute</code> the new
