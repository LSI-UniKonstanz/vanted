...
public interface Attributable {
	 ...
	 *               if there is no <code>Attribute</code> at the location specified by <code>path</code>.
	 */
	 ...
	 * @exception AttributeNotFoundException
	 *               if there is no <code>Attribute</code> at the specified location.
	 */
	 ...
	 * the ListenManager. Also sets the <code>parent</code> and the <code>attributable</code> of <code>attr</code>.
	 * <p>
	 * <b>Implementation Notes:</b><code>path</code> specifies the location of the CollectionAttribute or (in case <code>path</code> is the empty string) the
	 * Attributable <code>attr</code> should be added to. Usage should look as follows: <blockquote>
	 * 
	 * <pre>
	 * Graph g = new Graph(..);
	 ...
	 *               if there is already an <code>Attribute</code> with the same <code>id</code> as <code>attr</code> at location <code>path</code>.
	 * @exception NoCollectionAttributeException
	 *               if the <code>Attribute</code> at location <code>path</code> is not a <code>CollectionAttribute</code>.
	 */
	 ...
	 * @exception NoCollectionAttributeException
	 *               if the <code>Attribute</code> at the location specified by <code>path</code> is no <code>CollectionAttribute</code>.
	 * @exception AttributeExistsException
	 *               if there is already an <code>Attribute</code> with the given <code>id</code> at the
	 ...
	 * 
	 * @param path
	 *           the path to the <code>CollectionAttribute</code> the new <code>IntegerAttribute</code> should be added to.
	 * @param id
	 *           the id of the newly created <code>Attribute</code>.
	 * @param value
	 *           the value of the newly created <code>Attribute</code>.
