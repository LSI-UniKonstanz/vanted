...
public interface Attribute
	 ...
	 * is <code>null</code> before. Normaly only <code>addAttribute()</code> methods should call it.
	 * 
	 * @param parent
	 ...
	 * not x==y, i.e. some particular implementations can provide x==y but
	 ...
	 * i.e. some particular implementations can provide x==y but this
	 * behaviour is not general, in contrast x.equals(y) must be always
	 * guaranteed. <b>See documentation of particular implementations of this
	 * interface for exact specification of this method's behaviour!</b>
	 * 
