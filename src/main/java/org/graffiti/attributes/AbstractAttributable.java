...
public abstract class AbstractAttributable implements Attributable {
	 ...
	 * 
	 * @param coll
	 *           the <code>CollectionAttribute</code> of the new <code>AbstractAttributable</code> instance.
	 */
	 ...
	 * not yet exist. Appropriate (add and change) events are generated by
	 * calls to method <code>add(Attribute a)</code> in <code>CollectionAttribute</code> and method <code>setValue(Object
	 * o)</code> in <code>Attribute</code>. If more than one attributes have
	 * to be created while stepping down the path, only one event is
	 * generated, containing the attribute that has been created first (i.e.
	 * the root attribute of the newly appended hierarchy).
	 * 
	 * @param path
	 ...
	 * The <code>Attribute</code> is created at the given location, if it does
	 * not yet exist. Appropriate (add and change) events are generated by
	 * calls to method <code>add(Attribute a)</code> in CollectionAttribute
	 * and method <code>setValue(Object o)</code> in <code>Attribute</code>.
	 * If more than one attributes have to be created while stepping down the
	 * path, only one event is generated, containing the attribute that has
	 * been created first (i.e. the root attribute of the newly appended
	 * hierarchy).
	 * 
	 * @param path
	 *           the path to search for the <code>Attribute</code>.
	 ...
	 * The<code>Attribute</code>is created at the given location, if it does
	 * not yet exist. Appropriate (add and change) events are generated by
	 * calls of method <code>add(Attribute a)</code> in <code>CollectionAttribute</code> and method <code>setValue(Object
	 * o)</code> in <code>Attribute</code>. If more than one attributes have
	 * to be created while stepping down the path, only one event is
	 * generated, containing the attribute that has been created first (i.e.
	 * the root attribute of the newly appended hierarchy).
	 ...
	 * <p>
	 * <b>Implementation Notes:</b><code>path</code> specifies the location of the <code>CollectionAttribute</code> or (in case <code>path</code> is the empty
	 * string) the Attributable <code>attr</code> should be added to. Usage should look as follows: <blockquote>
	 * 
	 * <pre>
	 * Graph g = new Graph(..);
	 ...
	 *               if the<code>Attribute</code> at location <code>path</code> is not a CollectionAttribute.
	 ...
	 * 
	 * @param path
	 *           the path to the <code>CollectionAttribute</code> the new <code>BooleanAttribute</code> should be added to.
	 * @param id
	 ...
	 * 
	 * @param path
	 *           the path to the <code>CollectionAttribute</code> the new <code>ByteAttribute</code> should be added to.
	 * @param id
	 *           the id of the newly created <code>Attribute</code>.
	 * @param value
	 *           the value of the newly created <code>Attribute</code>.
	 ...
	 * 
	 * @param path
	 *           the path to the <code>CollectionAttribute</code> the new <code>DoubleAttribute</code> should be added to.
	 * @param id
	 *           the id of the newly created <code>Attribute</code>.
	 * @param value
	 *           the value of the newly created <code>Attribute</code>.
	 ...
	 * 
	 * @param path
	 *           the path to the <code>CollectionAttribute</code> the new <code>FloatAttribute</code> should be added to.
	 * @param id
	 *           the id of the newly created <code>Attribute</code>.
	 * @param value
	 *           the value of the newly created <code>Attribute</code>.
	 ...
	 *               with the given <code>id</code> at the given <code>path</code>.
	 * @throws FieldAlreadySetException
	 *            DOCUMENT ME!
	 */
	 ...
	 * 
	 * @param path
	 *           the path to the <code>CollectionAttribute</code> the new <code>LongAttribute</code> should be added to.
	 * @param id
	 *           the id of the newly created <code>Attribute</code>.
	 * @param value
	 *           the value of the newly created <code>Attribute</code>.
	 ...
	 * 
	 * @param path
	 *           the path to the <code>CollectionAttribute</code> the new <code>ShortAttribute</code> should be added to.
	 * @param id
	 *           the id of the newly created <code>Attribute</code>.
	 * @param value
	 *           the value of the newly created <code>Attribute</code>.
	 ...
	 * 
	 * @param path
	 *           the path to the <code>CollectionAttribute</code> the new <code>StringAttribute</code> should be added to.
	 * @param id
	 *           the id of the newly created <code>Attribute</code>.
	 * @param value
	 *           the value of the newly created <code>Attribute</code>.
