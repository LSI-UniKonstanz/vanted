...
public abstract class AbstractAttributable implements Attributable {
	...
	/**
	 * Constructs a new <code>AbstractAttribute</code> instance. Instantiates its
	 ...
	 * exist. Appropriate (add and change) events are generated by calls to method
	 * <code>add(Attribute a)</code> in <code>CollectionAttribute</code> and method
	 * <code>setValue(Object
	 * o)</code> in <code>Attribute</code>. If more than one attributes have to be
	 * created while stepping down the path, only one event is generated, containing
	 * the attribute that has been created first (i.e. the root attribute of the
	 * newly appended hierarchy).
	 * 
	 * @param path
	...
	public boolean getBoolean(String path) throws AttributeNotFoundException {
		...
		try {
			BooleanAttribute attr = (BooleanAttribute) attributes.getAttribute(path);

			return attr.getBoolean();
		} catch (ClassCastException cce) {
			throw new AttributeNotFoundException("No BooleanAttribute found at path " + path + ".");
		}
	}
	...
	public byte getByte(String path) throws AttributeNotFoundException {
		...
		try {
			...
			throw new AttributeNotFoundException("No ByteAttribute found at path " + path + ".");
		}
	}
	 ...
	 * <code>Attribute</code> is created at the given location, if it does not yet
	 * exist. Appropriate (add and change) events are generated by calls to method
	 * <code>add(Attribute a)</code> in CollectionAttribute and method
	 * <code>setValue(Object o)</code> in <code>Attribute</code>. If more than one
	 * attributes have to be created while stepping down the path, only one event is
	 * generated, containing the attribute that has been created first (i.e. the
	 * root attribute of the newly appended hierarchy).
	 * 
	 * @param path
	 *            the path to search for the <code>Attribute</code>.
	 * @param value
	...
	public double getDouble(String path) throws AttributeNotFoundException {
		...
		try {
			DoubleAttribute attr = (DoubleAttribute) attributes.getAttribute(path);

			return attr.getDouble();
		} catch (ClassCastException cce) {
			throw new AttributeNotFoundException("No DoubleAttribute found at path " + path + ".");
		}
	}
	...
	public float getFloat(String path) throws AttributeNotFoundException {
		...
		try {
			FloatAttribute attr = (FloatAttribute) attributes.getAttribute(path);

			return attr.getFloat();
		} catch (ClassCastException cce) {
			throw new AttributeNotFoundException("No FloatAttribute found at path " + path + ".");
		}
	}
	...
	public int getInteger(String path) throws AttributeNotFoundException {
		...
		try {
			IntegerAttribute attr = (IntegerAttribute) attributes.getAttribute(path);

			return attr.getInteger();
		} catch (ClassCastException cce) {
			throw new AttributeNotFoundException("No IntegerAttribute found at path " + path + ".");
		}
	}
	...
	public long getLong(String path) throws AttributeNotFoundException {
		...
		try {
			...
			throw new AttributeNotFoundException("No LongAttribute found at path " + path + ".");
		}
	}
	...
	public short getShort(String path) throws AttributeNotFoundException {
		...
		try {
			ShortAttribute attr = (ShortAttribute) attributes.getAttribute(path);

			return attr.getShort();
		} catch (ClassCastException cce) {
			throw new AttributeNotFoundException("No ShortAttribute found at path " + path + ".");
		}
	}

	/**
	 * Sets the <code>Attribute</code> at the given path to the given value.
	 * The<code>Attribute</code>is created at the given location, if it does not yet
	 * exist. Appropriate (add and change) events are generated by calls of method
	 * <code>add(Attribute a)</code> in <code>CollectionAttribute</code> and method
	 * <code>setValue(Object
	 * o)</code> in <code>Attribute</code>. If more than one attributes have to be
	 * created while stepping down the path, only one event is generated, containing
	...
	public String getString(String path) throws AttributeNotFoundException {
		...
		try {
			StringAttribute attr = (StringAttribute) attributes.getAttribute(path);

			return attr.getString();
		} catch (ClassCastException cce) {
			throw new AttributeNotFoundException("No StringAttribute found at path " + path + ".");
		}
	}
	 ...
	 * <code>add(Attribute a)</code> method from <code>CollectionAttribute</code>.
	 * <p>
	 * <b>Implementation Notes:</b><code>path</code> specifies the location of the
	 * <code>CollectionAttribute</code> or (in case <code>path</code> is the empty
	 * string) the Attributable <code>attr</code> should be added to. Usage should
	...
	public void addAttribute(Attribute attr, String path)
		...
		try {
			...
			throw new NoCollectionAttributeException(
					"The Attribute where you wanted to add another Attribute " + "is not a CollectionAttribute");
		}
	 ...
	 * <code>CollectionAttribute</code> at <code>path</code>. Events are generated
	 * by using the <code>add(Attribute a) </code> method from
	 * <code>CollectionAttribute</code>.
	 * 
	 * @param path
	...
	public void addBoolean(String path, String id, boolean value)
		...
		try {
			...
			throw new NoCollectionAttributeException("No CollectionAttribute at path " + path + ".");
		}
	}
	 ...
	 * Events are generated by using the <code>setInteger(int value) </code> method
	 * from <code>BooleanAttribute</code>.
	 * 
	 * @param path
	 *            the path to search for the <code>Attribute</code>.
	 * @param value
	...
	/**
	 * Sets the <code>Attribute</code> at the given path to the given value. Events
	 * are generated by using the <code>setInteger(int value) </code> method from
	 * <code>FloatAttribute</code>.
	 * 
	 * @param path
	 *            the path to search for the <code>Attribute</code>.
	 * @param value
	 ...
	 * Changes the <code>Attribute</code> at the given path to the given value.
	 * Events are generated by using the <code>setInteger(int value) </code> method
	 * from <code>IntegerAttribute</code>.
	 * 
	 * @param path
	 *            the path to search for the <code>Attribute</code>.
	 * @param value
	 ...
	 * Changes the <code>Attribute</code> at the given path to the given value.
	 * Events are generated by using the <code>setInteger(int value) </code> method
	 * from <code>StringAttribute</code>.
	 * 
	 * @param path
	 *            the path to search for the <code>Attribute</code>.
	 * @param value
	...
	public Attribute removeAttribute(String path) throws AttributeNotFoundException {
		...
		if (path.indexOf(Attribute.SEPARATOR) == -1) {
			...
			String parentPath = path.substring(0, path.lastIndexOf(Attribute.SEPARATOR));
			// had a "-1" here, did nobody test that?

			try {
				parentAttr = (CollectionAttribute) (attributes.getAttribute(parentPath));
			} catch (ClassCastException cce) {
				throw new AttributeNotFoundException("Parent of attribute is not a CollectionAttribute");
			}
		}

		Attribute attr = parentAttr.getAttribute(path.substring(path.lastIndexOf(Attribute.SEPARATOR) + 1));
	...
	private void doSet(String path, Object o, int attributeType) {
		...
		String[] subPaths = path.split("\\" + Attribute.SEPARATOR);
		...
		for (int i = 0; i < (subPaths.length - 1); i++) {
			try {
				...
				throw new NoCollectionAttributeException(
						"Attribute with id " + subPaths[i] + " is not a " + " CollectionAttribute.");
			}
		}
	...
	private static Attribute getDefaultAttribute(Object o, int attributeType, String[] subPaths) {
		...
		case BOOLEAN_ATTRIBUTE:
			a = new BooleanAttribute(subPaths[subPaths.length - 1], ((Boolean) o).booleanValue());

			break;

		case DOUBLE_ATTRIBUTE:
			a = new DoubleAttribute(subPaths[subPaths.length - 1], ((Double) o).doubleValue());

			break;

		case FLOAT_ATTRIBUTE:
			a = new FloatAttribute(subPaths[subPaths.length - 1], ((Float) o).floatValue());

			break;

		case INTEGER_ATTRIBUTE:
			a = new IntegerAttribute(subPaths[subPaths.length - 1], ((Integer) o).intValue());

			break;

		case STRING_ATTRIBUTE:
			a = StringAttribute.getTypedStringAttribute(subPaths[subPaths.length - 1], (String) o);
