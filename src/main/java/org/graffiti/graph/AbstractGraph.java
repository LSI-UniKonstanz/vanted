...
//
// ==============================================================================
// $Id: AbstractGraph.java,v 1.10 2010/12/22 13:05:33 klukas Exp $
...
public abstract class AbstractGraph extends AbstractAttributable implements Graph {
	...
	public boolean isDirected() {
		return isDirected;
		/*
		 * if (getEdges().size() == 0) return isDirected; else return getEdges().size()
	 ...
	 * <p>
	 * If <code>directed</code> is <code>true</code>, standard arrows are set, if it
	 * is <code>false</code>, all arrows of all edges are removed.
	 * 
	 ...
	 * edge arrows should be corrected.
	 * 
	 * @param directed
	 * @param adjustArrows
	 */
	 ...
	 * after the <code>preEdgeAdded</code> and before the <code>postEdgeAdded</code>
	 * event.
	 * 
	 * @param source
	 ...
	 * added edge through the call to <code>addEdge()</code>. Also informs the
	 * ListenerManager about the copy of the attributes added to the edge by adding
	 ...
	 * created node (after the <code>preNodeAdded</code> event and before the
	 * <code>postNodeAdded</code> event).
	 * 
	 * @return the new node.
	 */
	public Node addNode() {
	 ...
	 * newly added node in the same way as if a completely new node was added. Also
	 * informs the ListenerManager about the addition of attributes by using the
	 ...
	 * empty. A special event for clearing the graph will be passed to the listener
	 * manager.
	 */
	public void clear() {
	 ...
	 * implicitly. Then deletes the node and informs the ListenerManager about the
	 * deletion.
	 * 
	 * @param n
	 *            the node to delete.
	...
	private void unifyWithNodeAttribute(CollectionAttribute c) {
		if (c == null) { // base case
			...
			if (defaultNodeAttribute == null) { // base case
				...
				/*
				 * else { throw new UnificationException("Cannot unify " +
