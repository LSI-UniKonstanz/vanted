...
//
// ==============================================================================
// $Id: Node.java,v 1.6 2010/12/22 13:05:33 klukas Exp $
...
public interface Node
	...
	/**
	 * Union of <code>getDirectedInEdges()</code> and <code>getUndirectedEdges() </code>.
	 * 
	 * @return Collection
	 */
	...
	/**
	 * Union of <code>getInNeighbors()</code> and <code>getUndirectedNeighbors() </code>.
	 * 
	 * @return Collection
	 */
	...
	/**
	 * Union of <code>getDirectedOutEdges()</code> and <code>getUndirectedEdges() </code>.
	 * 
	 * @return Collection
	 */
	...
	/**
	 * Union of <code>getOutNeighbors()</code> and <code>getUndirectedNeighbors()</code>.
	 * 
	 * @return Collection
	 */
	...
	/**
	 * Returns a collection containing the outgoing directed edges of the <code>Node</code>.
	 * 
	 * @return a collection containing the outgoing directed edges of the <code>Node</code>.
	 */
	 ...
	 * the fact that multiple edges between the same two nodes are possible
	 * but the corresponding <code>Node</code> is only inserted once.
	 * 
	 ...
	 * the target of either an ingoing or an outgoing or an undirected <code>Edge</code>.
	 * 
	...
	/**
	 * Returns an interator over the neighbor nodes of the current <code>Node</code>. A neighbor <code>Node</code> is either the source or
	 * the target of either an ingoing or outgoing or undirected <code>Edge</code>.
	 * 
	 ...
	 * Note that the number of elements returned by this function might be
	 * less than the number returned by <code>getOutDegree()</code>, due to
	 * the fact that multiple edges between the same two nodes are possible
	 * but the corresponding <code>Node</code> is only inserted once.
	 * 
	 ...
	 * 
	 * @return an iterator containing all the neighbor <code>Node</code>s of
	 *         the current <code>Node</code> connected by an outgoing <code>Edge</code>.
	 */
	public Iterator<Node> getOutNeighborsIterator();
	
	/**
	 * Returns a collection containing the undirected ingoing and outgoing
	 * edges of the <code>Node</code>.
	 * 
	 * @return a collection containing the undirected ingoing and outgoing
	 *         edges of the <code>Node</code>.
	 */
	 ...
	 * 
	 * @return Returns the number of incoming directed edges + outgooing directed edges + number of connected undirected edges.
	 */
