...
public interface Graph extends Attributable, DeepCopy {
	 ...
	 * that all edges shall get one arrow at their tips (i.e. close to the target
	 * node).
	 * 
	 * @param directed
	 * @param adjustArrows
	...
	/**
	 * Returns a collection containing all the edges between n1 and n2. There can
	 * be more than one <code>Edge</code> between two nodes. The edges returned
	 * by this method can go from n1 to n2 or vice versa, be directed or not.
	 * 
	 * @param n1
	 ...
	 * same way as if a completely new <code>Node</code> was added. Also informs
	 * the ListenerManager about the addition of attributes.
	 * 
	 * @param node
	...
	/**
	 * Returns <code>true</code>, if the given attribute consumer was in the list
	 * of attribute consumers and could be removed.
	 * 
	 * @return <code>true</code>, if the given attribute consumer was in the list
	 *         of attribute consumers and could be removed.
	 */
	 ...
	 * 
	 * @param name
	 *           A ID that can be used for identifying the graph - for the user
