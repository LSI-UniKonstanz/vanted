...
public class StringSplitter {
	 ...
	 * String is returned as first entry of the returned String array.
	 * 
	 * @param toSplit
	 ...
	 * the returned String array with the results. If <code>delim</code> does
	 * not appear in <code>toSplit</code>, the whole String is returned as
	 ...
	 * String array with the results. If <code>delim</code> does not appear
	 * in <code>toSplit</code>, the whole String is returned as first entry of
	 * the returned String array. This method is faster than a call to <code>split(toSplit, delim, 2)</code>, but otherwise has the same
	 * result.
	 * 
	 * @param toSplit
	 *           the String that is split.
