...
public class StringSplitter {
	 ...
	 * not appear in <code>toSplit</code>, the whole String is returned as first
	 ...
	 * results. If <code>delim</code> does not appear in <code>toSplit</code>, the
	 * whole String is returned as first entry of the returned String array. This
	 * method is faster than a call to <code>split(toSplit, delim, 2)</code>, but
	...
	public static String[] splitInTwo(String toSplit, String delim) {
		...
		if (splitPos == -1) {
			...
			return new String[] { toSplit.substring(0, splitPos), toSplit.substring(splitPos + delim.length()) };
		}
	}
}
