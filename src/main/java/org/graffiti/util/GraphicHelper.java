...
//
// ==============================================================================
// $Id: GraphicHelper.java,v 1.5 2010/12/22 13:05:33 klukas Exp $
...
public class GraphicHelper implements HelperClass {
	...
	public static Point2D getIntersection(Line2D line1, Line2D line2) {
		...
		if (l2Direction_x != 0.0) {
			factor = p2.getY() - p1.getY() + ((l2Direction_y / l2Direction_x) * (p1.getX() - p2.getX()));
			...
			factor = p2.getX() - p1.getX() + ((l2Direction_x / l2Direction_y) * (p1.getY() - p2.getY()));
		...
		Point2D intersectionPoint = new Point2D.Double(p1.getX() + (factor * l1Direction_x),
				p1.getY() + (factor * l1Direction_y));
