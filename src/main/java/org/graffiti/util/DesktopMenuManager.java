...
//
// ==============================================================================
// $Id: DesktopMenuManager.java,v 1.9 2011/06/30 06:55:30 morla Exp $
...
public class DesktopMenuManager implements MenuListener, SessionListener {
	 ...
	 * @version $Revision: 1.9 $ $Date: 2011/06/30 06:55:30 $
	 */
	class FrameMenuItem extends JRadioButtonMenuItem implements ActionListener, Comparable<FrameMenuItem> {
		/**
		 * 
		 */
			...
			if (frame.isIcon()) {
				...
				if (parent == null) {
					MainFrame.showMessageDialog(
							"Window can't be activated. Internal error: frame-parent (JDesktopPane) is NULL.", "Error");
				} else {
