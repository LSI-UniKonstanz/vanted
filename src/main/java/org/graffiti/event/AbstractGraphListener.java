...
//
// ==============================================================================
// $Id: AbstractGraphListener.java,v 1.4 2010/12/22 13:05:34 klukas Exp $
 ...
 * objects.
 * <p>
 * Extend this class to create a <code>GraphEvent</code> listener and override the methods for the events of interest. (If you implement the
 * <code>GraphListener</code> interface, you have to define all of the methods in it. This abstract class defines <code>null</code> methods for them all, so you
 * can only have to define methods for events you care about.)
 * </p>
 * <p>
 * Create a listener object using the extended class and then register it with a component using the component's <code>addGraphEventListener</code> method. When
 * the structure of the graph object is changed or a transaction of graph changes is started or finished, the relevant method in the listener object is invoked
 * and the <code>GraphEvent</code> is passed to it.
 * </p>
 * 
