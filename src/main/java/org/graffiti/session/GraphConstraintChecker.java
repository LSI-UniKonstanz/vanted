...
/**
 * This class checks constraints on the graph. Constraints can arbitrarily
 * added an removed. <code>GraphConstraintChecker</code> is a listener to
 * graph, nodes, edges and attributes and checks the constraints after every
...
public class GraphConstraintChecker
	 ...
	 *               if the constraint checker does not
	 *               contain this <code>GraphConstraint</code> in his set of
	 *               constraints.
	 */
