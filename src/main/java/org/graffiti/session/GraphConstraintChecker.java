...
public class GraphConstraintChecker
	...
	/**
	 * Constructs a new <code>GraphConstraintChecker</code> checking constraints on
	 * the specified <code>Graph</code>.
	 * 
	 * @param g
	 *           the <code>Graph</code> on which to check the constraints.
	 * @param ccl
	 *           the <code>ConstraintCheckerListener</code> receiving failures of
	 *           constraints.
	 */
	...
	/**
	 * Returns the state of the constraint checker which contains a message telling
	 * which constraints are not satisfied.
	 * 
	 * @return the state of the constraint checker which contains a message telling
	 *         which constraints are not satisfied.
	...
	/**
	 * Called after an incoming edge has been removed from the node. (For undirected
	 * edges postUndirectedEdgeRemoved is called.)
	 * 
	 * @param e
	 *           The NodeEvent detailing the changes.
	 */
	...
	/**
	 * Called after an outgoing edge has been removed from the node. (For undirected
	 * edges postUndirectedEdgeRemoved is called.)
	 * 
	 * @param e
	 *           The NodeEvent detailing the changes.
	...
	/**
	 * Called just before an incoming edge is removed from the node. (For undirected
	 * edges preUndirectedEdgeRemoved is called.)
	 * 
	 * @param e
	 *           The NodeEvent detailing the changes.
	 */
	...
	/**
	 * Called just before an outgoing edge is removed from the node. (For undirected
	 * edges preUndirectedEdgeRemoved is called.)
	 * 
	 * @param e
	 *           The NodeEvent detailing the changes.
