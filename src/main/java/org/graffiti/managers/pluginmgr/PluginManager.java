...
public interface PluginManager {
	...
	/**
	 * Returns <code>true</code>, if the plugin with the given name is in the list
	 * of currently installed plugins.
	 * 
	 * @return DOCUMENT ME!
	 */
	...
	/**
	 * Loads the plugin from the given location. If several plugins should be loaded
	 * simultaniously, use <code>loadPlugins</code> instead, since dependencies can
	 ...
	 */
	public void loadPlugin(PluginDescription desc, URL pluginLocation, Boolean loadOnStartup)
	 ...
	 *           A ProgressViewer that display the progress made while loading the
	 *           plugins
	 * @exception PluginManagerException
	 *               if an error occurred while loading one of the plugins.
	 */
