...
//
// ==============================================================================
// $Id: ViewManager.java,v 1.5 2010/12/22 13:05:54 klukas Exp $
...
public interface ViewManager extends PluginManagerListener, ViewListener {
	...
	/**
	 * Returns <code>true</code>, if there is at least one registered view plugin
	 * available. /
	 * 
	 * @return DOCUMENT ME!
	 */
	...
	/**
	 * Returns <code>true</code>, if the given view manager listener was in the list
	...
	/**
	 * Removes the known list of views from the internal memory. Makes it possible
	 * to remove and re-add views.
	 */
