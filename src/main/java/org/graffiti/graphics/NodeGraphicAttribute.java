...
public class NodeGraphicAttribute extends GraphElementGraphicAttribute {
	...
	/**
	 * Constructor that sets the id to the given value, and initializes the other
	 ...
	 */
	public NodeGraphicAttribute(CoordinateAttribute c, DimensionAttribute d, PortsAttribute p)
			throws IllegalIdException {
		super(GRAPHICS);
	 ...
	 * additional values are simply added (that means that if there exists already a
	...
	public void setCollection(Map<String, Attribute> attrs) {
		if (attrs.keySet().contains(COORDINATE) && attrs.keySet().contains(DIMENSION) && attrs.keySet().contains(SHAPE)
				&& attrs.keySet().contains(PORTS) && attrs.keySet().contains(BGIMAGE)
