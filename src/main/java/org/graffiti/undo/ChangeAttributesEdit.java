...
public class ChangeAttributesEdit extends GraffitiAbstractUndoableEdit {
	...
	/**
	 * Creates a new <code>AttributeChangeEdit</code> object. It is usefull if only
	 * one attribute such as coordinate of a bend has been changed.
	 * 
	 * @param attribute
	...
	private void changeValues() {
		try {
			...
			/*
			 * maps from an old attribute: attribute belonged to a deleted graph element -
			 * to a new possibly created attribute at a new graph element
			 */
