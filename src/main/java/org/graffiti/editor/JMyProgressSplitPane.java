...
public class JMyProgressSplitPane extends JSplitPane {
	...
	public int getDividerLocation() {
		...
		/*
		 * if (progressPanel==null) return super.getDividerLocation(); int height=0;
		 * Component[] gc=progressPanel.getComponents(); for (int i=0; i<gc.length; i++)
		 * { height+=gc[i].getPreferredSize().height; } return getHeight()-height;
		 */
	}
}
