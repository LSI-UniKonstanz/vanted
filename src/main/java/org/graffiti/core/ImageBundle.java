...
//
// ==============================================================================
// $Id: ImageBundle.java,v 1.5 2010/12/22 13:05:33 klukas Exp $
 ...
 * instance of a <code>ImangeBundle</code> created.
 * 
 * @see GenericBundle
 */
public class ImageBundle extends GenericBundle {
	...
	/**
	 * Returns the specified image icon or a blank icon, if the specified image icon
	 * could not be found.
	 * 
	 * @param name
	...
	/**
	 * Returns the specified image or a blank image, if the specified image could
	 * not be found.
	 * 
	 * @param name
	 *           the property name of the icon.
