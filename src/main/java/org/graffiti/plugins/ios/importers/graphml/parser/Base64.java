...
//
// ==============================================================================
// $Id: Base64.java,v 1.8 2011/01/16 16:39:59 klukas Exp $
 ...
 * <a href="http://iharder.net/xmlizable">http://iharder.net/base64</a>
...
public class Base64 {
	...
	/** DOCUMENT ME! */
	private static final byte[] _NATIVE_ALPHABET = { (byte) 'A', (byte) 'B', (byte) 'C', (byte) 'D', (byte) 'E',
	...
	/**
	 * Encodes the first three bytes of array <var>threeBytes</var> and returns a
	 ...
	 * significant bytes in your array is given by <var>numSigBytes</var>. The array
	...
	public static class InputStream extends java.io.FilterInputStream {
		...
		/**
		 * Calls read repeatedly until the end of stream is reached or <var>len</var>
		 * bytes are read. Returns number of bytes read into array or -1 if end of
	...
	public static class OutputStream extends java.io.FilterOutputStream {
		 ...
		 * notation. When encoding, bytes are buffered three at a time before the output
		 * stream actually gets a write() call. When decoding, bytes are buffered four
		 * at a time.
		 *
		 * @param theByte
		 *           the byte to write
