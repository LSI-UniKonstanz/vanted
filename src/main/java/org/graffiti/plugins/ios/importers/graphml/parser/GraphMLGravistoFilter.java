 ...
 * not supported by Gravisto and doing error handling. Gravisto does not
 * support nested graphs, hyperedges and locators as specified in the <a
 * href="http://graphml.graphdrawing.org/specification">graphML
 * specification</a>.
 *
 * @author ruediger
 */
class GraphMLGravistoFilter
    extends XMLFilterImpl
{
     ...
     *
     * @param reader the parent <code>XMLReader</code>.
     */
     ...
     * being processed is ignorable and if not forwards the character data
     * event to the parent parser.
     *
     * @param ch nn array of characters.
        ...
        throws SAXException
    {
        ...
        if(qName.equals("graph"))
        {
            ...
            this.nesting + ").";
            logger.fine("end of " + ((this.nesting == 0) ? "" : "embedded ") +
                "graph detected");
     ...
     * embedded graph, a hyperedge etc. Otherwise it returns
     * <code>false</code>.
     *
