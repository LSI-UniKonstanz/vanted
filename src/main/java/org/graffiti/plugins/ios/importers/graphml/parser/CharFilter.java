...
//
// ==============================================================================
// $Id: CharFilter.java,v 1.6 2011/01/16 16:39:59 klukas Exp $
...
class CharFilter extends XMLFilterImpl {
	...
	/**
	 * Filter an end document event and fire a character data event if necessary.
	 *
	 * @exception SAXException
	 *               the client may throw an exception during processing.
	 */
	...
	/**
	 * Filter an end Namespace prefix mapping event and fire a character data event
	 * if necessary.
	 *
	 * @param prefix
	...
	/**
	 * Filter a skipped entity event and fire a character data event if necessary.
	 *
	 * @param name
	...
	/**
	 * Filter a start element event and fire a character data event if necessary.
	 *
	 * @param uri
	 *           the element's Namespace URI, or the empty string.
	 * @param localName
	...
	/**
	 * Filter a start Namespace prefix mapping event and fire a character data event
	 * if necessary.
	 *
	 * @param prefix
	 *           the Namespace prefix.
	 ...
	 * <code>characters()</code> method of the parent filter should be called before
