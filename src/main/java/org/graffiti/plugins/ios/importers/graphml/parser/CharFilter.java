 ...
 * and merges them into one call. The character data from these events is
 * stored in a buffer and a new character data event is fired towards the
 * parent filter once a different event comes from the parser.
 *
 * @author ruediger
 */
class CharFilter
    extends XMLFilterImpl
{
    ...
    /**
     * Filter an end element event and fire a character data event if
     * necessary.
     *
