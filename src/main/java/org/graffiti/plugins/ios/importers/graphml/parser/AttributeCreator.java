...
abstract class AttributeCreator
{
	...
	/**
	 * Returns a <code>Map</code> mapping attribute paths to <code>Object</code>s containing the declared default values of the
	 * corresponding attributes. The <code>Object</code>s can - according to
	 * the graphML specification be either of Type <code>Boolean</code>, <code>Integer</code>, <code>Long</code>, <code>Float</code>, <code>Double</code> or
	 * <code>String</code>.
	 *
	...
	void addDefaultValue(String value)
	{
		...
		if (this.defType.equals("boolean"))
		{
			...
			if (this.defType.equals("int"))
			{
				val = Integer.valueOf(value);
			}
			else
				if (this.defType.equals("long"))
				{
					val = Long.valueOf(value);
				}
				else
					if (this.defType.equals("float"))
					{
						val = Float.valueOf(value);
					}
					else
						if (this.defType.equals("double"))
						{
	 ...
	 *           declaration.
	 * @param type
	 *           the type from the corrsponding graphML &lt;key&gt:
	 *           declaration.
	 */
