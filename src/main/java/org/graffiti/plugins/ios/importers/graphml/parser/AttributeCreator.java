...
//
// ==============================================================================
// $Id: AttributeCreator.java,v 1.6 2011/01/16 16:39:59 klukas Exp $
 ...
 * delcaration is known. There can be more than one attribute type for a given
...
abstract class AttributeCreator {
	...
	/**
	 * A <code>Map</code> mapping paths to <code>Attributes</code> set to a declared
	 * default value (using the &lt;default&gt;-element of graphML).
	 */
	private Map defAttrMap;

	/**
	 * Maps the id of a graphML key declaration to the corresponding attribute path
	 * and type.
	 */
	private Map keyMap;

	/**
	 * Temporarily contines the path of an attribute that has a default value
	 * declaration.
	 */
	private String defPath;

	/**
	 * Temporarily contines the type of the default value that was declared for an
	 * attribute.
	 */
	...
	AttributeCreator() {
		...
		this.defAttrMap = new Hashtable();
	}

	// ~ Methods ================================================================

	/**
	 * Sets the path and the type of an attribute to which a default value shall be
	 * assigned.
	 *
	 * @param name
	...
	/**
	 * Returns a <code>Map</code> mapping attribute paths to <code>Object</code>s
	 * containing the declared default values of the corresponding attributes. The
	 * <code>Object</code>s can - according to the graphML specification be either
	 * of Type <code>Boolean</code>, <code>Integer</code>, <code>Long</code>,
	 * <code>Float</code>, <code>Double</code> or <code>String</code>.
	 *
	 * @return a <code>Map</code> mapping attribute paths to Objects containing the
	 *         declared default values of the corresponding attributes.
	 */
	Map getDefaults() {
	...
	/**
	 * Creates and returns a <code>CollectionAttribute</code> that will be assigned
	 * by default.
	 *
	 * @return a <code>CollectionAttribute</code> that will be assigned by default.
	 */
	abstract CollectionAttribute createDefaultAttribute();

	/**
	 * Returns the name of the attribute that has been declared with the given id.
	 *
	 * @param id
	...
	String getName(String id) {
		KeyDeclaration kd = (KeyDeclaration) this.keyMap.get(id);
		if (kd != null)
			return kd.getPath();
		return null;
	}
	...
	/**
	 * Returns the type of the attribute that has been declared with the given id.
	 *
	 * @param id
	 *            the id the attribute has been declared with.
	...
	/**
	 * Adds the default value for an attribute whose type and path must have been
	 * set using the method <code>setDefault</code> before.
	 *
	 * @param value
	 ...
	 *
	 * @param id
	 *            the id of the corrsponding graphML &lt;key&gt: declaration.
	 * @param name
	 *            the attribute name from the corrsponding graphML &lt;key&gt:
	 *            declaration.
	 * @param type
	 *            the type from the corrsponding graphML &lt;key&gt: declaration.
	 */
	...
	/**
	 * Class <code>KeyDeclaration</code> groups an attribute path and an attribute
	 * type into one object.
	 */
