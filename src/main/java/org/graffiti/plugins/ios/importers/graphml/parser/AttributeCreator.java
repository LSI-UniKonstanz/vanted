 ...
 * provides functionality for setting default values to an attribute and it
 * can be queried the type and the path of an attribute of which the id from
 * the delcaration is known. There can be more than one attribute type for a
 * given attribute path. Therefore the type and the path are queried by the id
 * which is unique.
 *
 * @author ruediger
 */
abstract class AttributeCreator
{
    ...
    /**
     * Temporarily contines the type of the default value that was declared for
     * an attribute.
     */
    ...
    /**
     * Sets the path and the type of an attribute to which a default value
     * shall be assigned.
     *
     * @param name the path of the attribute.
     * @param type the type of the default attribute value.
     */
    ...
    /**
     * Returns a <code>Map</code> mapping attribute paths to
     * <code>Object</code>s containing the declared default values of the
     * corresponding attributes. The <code>Object</code>s can - according to
     * the graphML specification be either of Type <code>Boolean</code>,
     ...
     * id.
     *
     * @param id the id the attribute has been declared with.
     *
     ...
     *
     * @param value the value of the attribute as declared in graphML.
     */
     ...
     *
     * @param id the id of the corrsponding graphML &lt;key&gt: declaration.
     * @param name the attribute name from the corrsponding graphML &lt;key&gt:
     *        declaration.
     * @param type the type from the corrsponding graphML &lt;key&gt:
     *        declaration.
     */
