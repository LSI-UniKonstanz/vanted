    ...
    implements EntityResolver
{
    ...
    public InputSource resolveEntity(String publicId, String systemId)
    {
        ...
        if(systemId.startsWith(graphmlURL1))
        {
            ...
            else if(systemId.endsWith(graphmlURL1 + "graphml-parseinfo.xsd"))
            {
        ...
        else if(systemId.startsWith(graphmlURL2))
        {
            ...
            else if(systemId.equals(graphmlURL2 +
        ...
        else if(systemId.endsWith("graphml-attributes.xsd") ||
     ...
     * retuns it.
     *
     * @param resource the resource to be determined.
     *
