...
//
// ==============================================================================
// $Id: Base64.java,v 1.7 2011/01/03 12:35:17 klukas Exp $
 ...
 * instead! Please visit <a href="http://iharder.net/xmlizable">http://iharder.net/base64</a> periodically to check for updates or to contribute improvements.
 * </p>
 * 
...
public class Base64 {
	 ...
	 * serialized object. If the object cannot be serialized or there is
	 * another error, the method will return <tt>null</tt>. The object is not
	 ...
	 * @since 1.5.1
	 */
	static byte[] encode3to4(byte[] b4, byte[] threeBytes,
						int numSigBytes) {
	...
	/**
	 * A {@link Base64.InputStream} will read data from another {@link java.io.InputStream}, given in the constructor, and encode/decode
	...
	/**
	 * A {@link Base64.OutputStream} will write data to another {@link java.io.OutputStream}, given in the constructor, and encode/decode
	 * to/from Base64 notation on the fly.
	 * 
	 * @see Base64
	...
	public static class OutputStream
		...
		/**
		 * Resumes encoding of the stream. May be helpful if you need to embed
		 ...
		 * the output stream actually gets a write() call. When decoding,
		 * bytes are buffered four at a time.
		 * 
		 * @param theByte
		 *           the byte to write
		 * @throws java.io.IOException
