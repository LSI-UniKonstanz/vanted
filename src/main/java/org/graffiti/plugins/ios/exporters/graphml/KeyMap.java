...
//
// ==============================================================================
// $Id: KeyMap.java,v 1.5 2011/01/03 12:35:17 klukas Exp $
...
class KeyMap {
	...
	/**
	 * Returns all the possible types an attribute at the given path can have along
	 * with the corresponding id.
	 * 
	 * @param path
	 *            the path for which to determine the possible types.
	 * @return an array containing all the types along with the corresponding id.
	 */
	 ...
	 * exist there yet. Returns the id of the mapping if it already exists, if not
