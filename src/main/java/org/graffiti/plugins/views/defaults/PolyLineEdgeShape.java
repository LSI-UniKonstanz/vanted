...
//
// ==============================================================================
// $Id: PolyLineEdgeShape.java,v 1.16 2010/12/22 13:06:19 klukas Exp $
...
public class PolyLineEdgeShape extends LineEdgeShape {
		...
		if (this.bends.isEmpty()) {
			...
			if (!it.hasNext()) {
				...
				while (it.hasNext()) {
					...
					// still to go
					this.linePath.lineTo((float) bend.getX(), (float) bend.getY());
				}
			}
	 ...
	 * point. It approximates the path using a <code>FlatteningPathIterator</code>
	 * and uses the method <code>lineContains</code> that uses a certain tolerance.
	 * 
	 * @param path
	 * @param x
	 * @param y
