...
//
// ==============================================================================
// $Id: LineModeEditComponent.java,v 1.5 2010/12/22 13:05:57 klukas Exp $
...
public class LineModeEditComponent extends AbstractValueEditComponent {
	...
	public JComponent getComponent() {
		...
		JComponent phaseComp = (new FloatEditComponent(new FloatAttribute("phase", lmAttr.getDashPhase())))
				.getComponent();
		...
		if (dashs != null) {
			...
			for (int i = 0; i < dashs.length; i++) {
				dashComp = new FloatEditComponent(new FloatAttribute("dash" + i, dashs[i])).getComponent();
