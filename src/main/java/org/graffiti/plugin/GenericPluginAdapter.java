...
//
// ==============================================================================
// $Id: GenericPluginAdapter.java,v 1.10 2010/12/22 13:05:34 klukas Exp $
...
public abstract class GenericPluginAdapter implements GenericPlugin {
	...
	/**
	 * The default plugin icon for plugin implementations, which do not overwrite
	 * the <code>getIcon</code> method in this class.
	 */
	 ...
	 * 
	 * @return the default plugin icon for a plugin implementation, which does not
	...
	/**
	 * Returns the array of <code>org.graffiti.plugin.view.View</code>s the plugin
	 * contains.
	 * 
	 * @return the array of <code>org.graffiti.plugin.view.View</code>s the plugin
	 *         contains.
	 */
