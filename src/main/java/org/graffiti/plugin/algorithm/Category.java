...
public enum Category {
	 ...
	 */
	GRAPH("Graph", "Algorithm working on graphs"), EDGE("Graph-Edges", "Algorithm working on graph edges"),
	...
	ANNOTATION("Annotation",
			"Algorithm performing annotation tasks (labeling, hierarchies, ontologies) on graph, graph elements, or data"),
	MAPPING("Mapping",
			"Algorithm performing mapping tasks (in)between network and data domains (network-network / network-data / data-data)"),
	...
	IMPORT("Import", "Algorithm importing data"), EXPORT("Export", "Algorithm exporting data"),
	ENRICHMENT("Enrichment", "Algorithm does enrichment operations on hierarchical networks"), HIERARCHY("Hierachy",
