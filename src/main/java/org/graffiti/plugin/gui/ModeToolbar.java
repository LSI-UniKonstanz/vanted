...
public class ModeToolbar extends GraffitiToolbar {
	 ...
	 * adding their ToolButtons to this toolbar. The orientation is set to vertical
	 * by default.
	 * 
	 * @param m
	 ...
	 * button group this toolbar contains. If the component is no
	 * <code>ToolButton</code> it is added to the end, else it is added at the end
