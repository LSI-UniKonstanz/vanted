...
public interface View
		extends GraphListener, NodeListener, EdgeListener, AttributeListener, Autoscroll, ZoomListener, Zoomable // AttributeConsumer
{
	...
	/**
	 * Returns the main <code>GraphElementComponent</code> associated with the given
	...
	/**
	 * Called when a graphics attributes of the Graph represented by this view has
	 * changed.
	 * 
	 * @param attr
	...
	/**
	 * Adds a message listener to the view. If the view have been started without
	 * editor instance, this method may be empty.
	 * 
	 * @param ml
	 *           a message listener
	 */
	...
	/**
	 * @return Null, or a Double Object specifying the height (or a
	 *         TableLayout-constant) of empty space or a JComponent, placed above
	 *         the graph view and sized according to its preferred height, the full
	...
	/**
	 * @return Null, or a Double Object specifying the height (or a
	 *         TableLayout-constant) of empty space or a JComponent, placed below
	 *         the graph view and sized according to its preferred height, the full
	 *         width of the window is used.
	 */
	...
	/**
	 * @return Null, or a Double Object specifying the width (or a
	 *         TableLayout-constant) of empty space or a JComponent, placed left of
	 *         the graph view and sized according to its preferred height, the
	 *         height of graph view next to the component is used.
	 */
	public Object getViewToolbarComponentLeft();
	
	/**
	 * @return Null, or a Double Object specifying the width (or a
	 *         TableLayout-constant) of empty space or a JComponent, placed to the
	 *         right of the graph view and sized according to its preferred height,
	 *         the height of graph view next to the component is used.
	 */
	public Object getViewToolbarComponentRight();
	
	/**
	 * @return Either null or JComponent, placed behind the graph view. The size
	 *         corresponds to the window size. Certain components may draw over the
	 *         graph view, resulting in redraw bugs. But a simple JComponent with
	 *         hand-made paint-code should work fine.
	 */
