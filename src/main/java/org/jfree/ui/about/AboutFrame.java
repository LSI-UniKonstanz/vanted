 ...
 * Contributor(s): -;
 * $Id: AboutFrame.java,v 1.2 2010/12/14 07:02:05 morla Exp $
...
public class AboutFrame extends JFrame {
	...
	public AboutFrame(final String title, final ProjectInfo project) {
		...
		this(title,
							...
							Arrays.asList(project.getLibraries()));
	...
	public AboutFrame(final String title,
								final String application, final String version, final String info,
								final Image logo,
		...
		final JTabbedPane tabs = createTabs();
		content.add(tabs);
	...
	private JPanel createAboutPanel() {
		...
		if (this.libraries != null) {
			final JPanel librariesPanel = new LibraryPanel(this.libraries);
