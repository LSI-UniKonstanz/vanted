 ...
 * Contributor(s): -;
 * $Id: SystemPropertiesPanel.java,v 1.2 2010/12/14 07:02:05 morla Exp $
 * Changes
 * -------
...
public class SystemPropertiesPanel extends JPanel {
	...
	class PopupListener extends MouseAdapter {
		...
		private void maybeShowPopup(final MouseEvent e) {
			if (e.isPopupTrigger()) {
				SystemPropertiesPanel.this.copyPopupMenu.show(
									SystemPropertiesPanel.this.table, e.getX(), e.getY()
									);
			}
		}
	}
