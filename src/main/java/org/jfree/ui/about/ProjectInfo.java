 ...
 * Contributor(s): -;
 * $Id: ProjectInfo.java,v 1.2 2010/12/14 07:02:05 morla Exp $
...
public class ProjectInfo extends BootableProjectInfo {
	 ...
	 *           the version.
	 * @param info
	 *           other info (usually a URL).
	 * @param logo
	 *           the project logo.
	 * @param copyright
	 *           a copyright statement.
	 * @param licenceName
	 *           the name of the licence that applies to the project.
	 * @param licenceText
	 *           the text of the licence that applies to the project.
	 */
	...
	public String toString() {
		...
		final List contributors = getContributors();
		if (contributors != null) {
			final Iterator iterator = getContributors().iterator();
