 ...
 * $Id: DowngradeActionMap.java,v 1.2 2010/12/14 07:02:06 morla Exp $
 * Changes
 * -------
 ...
 * <p>
 * This implementation does not implement the ActionMap interface of JDK 1.3 or higher to maintain the compatibility with JDK 1.2 which does not know this
 * interface.
 * <p>
...
public class DowngradeActionMap {
	 ...
	 * for <code>key</code>.
	 * <p>
	 * In most instances, <code>key</code> will be <code>action.getValue(NAME)</code>.
	 * 
	 * @param key
