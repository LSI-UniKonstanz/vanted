 ...
 * Arnaud Lelievre;
 * $Id: InsetsChooserPanel.java,v 1.2 2010/12/14 07:02:03 morla Exp $
...
public class InsetsChooserPanel extends JPanel {
	...
	public InsetsChooserPanel(Insets current) {
		...
		panel.add(this.leftValueEditor,
		...
		panel.add(new JLabel(" "),
							new GridBagConstraints(2, 2, 1, 1, 0.0, 0.0,
														GridBagConstraints.CENTER, GridBagConstraints.NONE,
														new Insets(0, 12, 0, 12), 8, 0));
		panel.add(this.rightValueEditor,
		...
		panel.add(new JLabel(localizationResources.getString("Right")),
							new GridBagConstraints(4, 2, 1, 1, 0.0, 0.0, GridBagConstraints.CENTER,
														...
														new Insets(0, 4, 0, 4), 0, 0));
		// Fourth row
		panel.add(this.bottomValueEditor,
	...
	public Insets getInsets() {
		return new Insets(Math.abs(stringToInt(this.topValueEditor.getText())),
