 ...
 * Contributor(s): -;
 * $Id: WizardDialog.java,v 1.2 2010/12/14 07:02:03 morla Exp $
 ...
 * <P>
 * When the user backs up by one or more steps, the dialog keeps the completed steps so that they can be reused if the user doesn't change anything - this
 * handles the cases where the user backs up a few steps just to review what has been completed.
 * <p>
...
public class WizardDialog extends JDialog implements ActionListener {
	...
	public void actionPerformed(final ActionEvent event) {
		...
		if (command.equals("nextButton")) {
			...
			if (command.equals("previousButton")) {
				previous();
			} else
