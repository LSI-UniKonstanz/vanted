 ...
 * $Id: Align.java,v 1.2 2010/12/14 07:02:03 morla Exp $
...
public final class Align {
	 ...
	 * 
	 * @param rect
	 *           the rectangle to be aligned (<code>null</code> not permitted).
	 * @param frame
	 *           the reference frame (<code>null</code> not permitted).
	 * @param align
	 *           the alignment code.
	 */
