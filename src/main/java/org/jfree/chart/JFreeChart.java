 ...
 * series data).
 * <P>
 * JFreeChart coordinates several objects to achieve its aim of being able to draw a chart on a Java 2D graphics device: a list of {@link Title} objects, a
 * {@link Legend}, a {@link Plot} and a {@link org.jfree.data.Dataset} (the plot in turn manages a horizontal axis and a vertical axis).
 * <P>
...
public class JFreeChart implements Drawable,
	 ...
	 * Constructs a chart.
	 * <P>
	 * Note that the {@link ChartFactory} class contains static methods that will return a ready-made chart.
	 * 
	 * @param plot
	 *           controller of the visual representation of the data (<code>null</code> not
	 *           permitted).
	 */
	 ...
	 *           the chart title (<code>null</code> permitted).
	 * @param titleFont
	 *           the font for displaying the chart title (<code>null</code> permitted).
	 * @param plot
	 *           controller of the visual representation of the data (<code>null</code> not
	 *           permitted).
	 * @param createLegend
	...
	/**
	 * Sets the chart title. This is a convenience method that ends up calling the {@link #setTitle(TextTitle)} method.
	 * 
	 * @param title
	 ...
	 * <p>
	 * NOTE: if the plot is not an instance of {@link CategoryPlot}, then a <code>ClassCastException</code> is thrown.
	 * 
	 * @return the plot.
	 */
	 ...
	 * <p>
	 * NOTE: if the plot is not an instance of {@link XYPlot}, then a <code>ClassCastException</code> is thrown.
	 * 
	 * @return the plot.
	 */
	...
	/**
	 * Returns the background image alignment. Alignment constants are defined in the <code>com.jrefinery.ui.Align</code> class in the JCommon class library.
	 * 
	 ...
	 *           the area within which the chart should be drawn.
	 * @param anchor
	 *           the anchor point (in Java2D space) for the chart (<code>null</code> permitted).
	 * @param info
	 *           records info about the drawing (null means collect no info).
	 */
	 ...
	 *           the height.
	 * @param info
	 *           carries back chart state information (<code>null</code> permitted).
	 * @return a buffered image.
	 */
	 ...
	 * <P>
	 * JFreeChart is not a UI component, so some other object (e.g. ChartPanel) needs to capture the click event and pass it onto the JFreeChart object. If you
	 * are not using JFreeChart in a client application, then this method is not required (and hopefully it doesn't get in the way).
	 * 
	 * @param x
...
/**
 * Information about the JFreeChart project. One instance of this class is assigned to <code>JFreeChart.INFO<code>.
 */
