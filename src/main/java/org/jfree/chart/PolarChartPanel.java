...
public class PolarChartPanel extends ChartPanel {
	 ...
	 *           the title.
	 * @param data
	 *           the dataset for the chart where each series is a collection of
	 *           (theta,radial) values.
	 * @return a polar chart.
	 */
	// public static PolarChartPanel createPolarChartPanel(String title, XYDataset
	// data) {
	...
	// JFreeChart chart = new JFreeChart(title, JFreeChart.DEFAULT_TITLE_FONT, plot,
	// true);
