 ...
 * $Id: LegendPropertyEditPanel.java,v 1.2 2010/12/14 07:02:04 morla Exp $
...
class LegendPropertyEditPanel extends JPanel implements ActionListener {
	...
	private void attemptModifySeriesPaint() {
		Color c;
		c = JColorChooser.showDialog(this, localizationResources.getString("Series_Label_Color"), Color.blue);
		if (c != null) {
