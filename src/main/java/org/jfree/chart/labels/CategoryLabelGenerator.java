 ...
 * ---------------------------
 * CategoryLabelGenerator.java
 * ---------------------------
 * (C) Copyright 2001-2004, by Object Refinery Limited.
 * Original Author: David Gilbert (for Object Refinery Limited);
 * Contributor(s): -;
 * $Id: CategoryLabelGenerator.java,v 1.2 2010/12/14 07:02:03 morla Exp $
 * Changes
 * -------
 ...
 * 11-May-2004 : Renamed CategoryItemLabelGenerator --> CategoryLabelGenerator (DG);
 */
