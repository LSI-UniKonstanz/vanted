 ...
 * $Id: DemoResources_es.java,v 1.3 2010/12/14 09:27:16 morla Exp $
 * Changes
 * -------
...
public class DemoResources_es extends ListResourceBundle {
	...
	private static final Object[][] CONTENTS = {
			...
			{ "tab.bar", "Gr�fico de barras" }, { "tab.pie", "Gr�fico circular" }, { "tab.xy", "XY Gr�ficos" },
			{ "tab.time", "Gr�fico de la serie de  tiempo" }, { "tab.other", "Otros gr�ficos" },
			{ "tab.test", "Gr�ficos de examen" }, { "tab.combined", "Gr�ficos combinados" },
			...
			{ "chart1.description", "Muestra barras horizontales, representando data desde a "
					+ "Categor�a dataset (grupo data).  Preste atenci�n que el eje " + "num�rico esta invertido." },

			{ "chart2.title", "Gr�fico con pilas de barras horizontales: " },
			{ "chart2.description",
					"muestra gr�fico con pilas de barras horizontales,  " + "representando data desde a "
							+ "Categor�a dataset (grupo data)." },

			{ "chart3.title", "Gr�fico con barras verticales: " },
			{ "chart3.description",
					"Muestra barras verticales, representando data " + "de una categor�a dataset (grupo data)." },

			{ "chart4.title", "Gr�fico de barra vertical en 3D: " },
			{ "chart4.description",
					"muestra  barras verticales con un efecto de 3D, " + "representando data desde a "
							+ "Categor�a dataset (grupo data)." },

			{ "chart5.title", "Gr�fico con pilas de barras verticales: " },
			{ "chart5.description",
					"muestra gr�fico con pilas de barras verticales, " + "representando data desde a "
							+ "Categor�a dataset (grupo data)." },

			{ "chart6.title", "Gr�fico con pilas de barras en 3D: " },
			{ "chart6.description",
					"Muestra pila de  barras verticales con un efecto de 3D, "
			...
			{ "chart8.description",
					"Un gr�fico circular mostrando porcentajes sobre los " + "niveles categ�ricos.  Tambi�n, "
							+ "este plan tiene una imagen de fondo." },

			{ "chart9.title", "Plan XY: " },
			{ "chart9.description",
					"un gr�fico de l�nea usando data desde un grupo de data XY.  " + "Ambos ejes son num�rico." },

			{ "chart10.title", "Series de tiempo 1: " },
			{ "chart10.description",
					"un gr�fico de series de tiempo, representando data "
			...
			{ "chart11.description",
					"Un gr�fico de series de tiempo, representando un grupo "
							+ "de data XY. Este ejes verticales tienen una escala " + "logar�tmica." },
			...
			{ "chart13.description",
					"Un gr�fico alto/bajo/abierto/cerrado basado sobre " + "data en un grupo de data alto bajo." },
			...
			{ "chart16.description",
					"un plan de viento, representa la direcci�n del "
							+ "viento e intensidad  ( suministro a trav�s de  " + "un grupo data de viento)." },
			...
			{ "chart18.description", "un gr�fico mostrando l�neas y/o figuras, representando "
					...
					+ "ilustra el uso de a imagen de fondo en el gr�fico, y " + "alpha-transparency en �l plan." },

			{ "chart19.title", "Gr�fico de barra vertical XY: " },
			{ "chart19.description",
					"Un gr�fico mostrando barras verticales, basadas en data en un " + "grupo data interval XY." },

			{ "chart20.title", "Data Nula: " }, { "chart20.description", "Un gr�fico con un grupo data nulo." },
			...
			{ "chart23.description",
					"un gr�fico de barra con serie �nica.  " + "Este gr�fico tambi�n ilustra el uso "
							+ "de un borde alrededor de ChartPanel." },

			{ "chart24.title", "Gr�fico din�mico: " },
			{ "chart24.description", "Un gr�fico din�mico, para examinar la notificaci�n del " + "evento mec�nico." },

			{ "chart25.title", "Gr�fico cubierto: " },
			{ "chart25.description",
					"muestra un gr�fico cubierto con alto/bajo/abierto/cerrado " + "y movi�ndose planes en promedio." },

			{ "chart26.title", "Gr�fico combinado horizontalmente: " },
			{ "chart26.description",
					"Muestra un gr�fico combinado horizontalmente de la serie " + "de tiempo y una barra XY planes." },

			{ "chart27.title", "Gr�fico combinado verticalmente: " },
			{ "chart27.description",
					"Muestra un gr�fico combinado verticalmente de XY, " + "serie de tiempo y VerticalXYBar planes." },

			{ "chart28.title", "Gr�fico combinado y cubierto: " },
			{ "chart28.description",
					"Un gr�fico combinado de una XY, cubierto de series de "
							+ "tiempo y uno cubierto altobajo & planes de series de tiempo." },

			{ "chart29.title", "Gr�fico din�mico combinado y cubierto: " },
			{ "chart29.description",
					"muestra un gr�fico din�mico combinado y cubierto, "
							+ "para examinar el notificaci�n de evento mec�nico." },

			{ "charts.display", "Muestra" },

			// chart titles and labels...
			{ "bar.horizontal.title", "Gr�fico de barra horizontal" }, { "bar.horizontal.domain", "Categor�as" },
			{ "bar.horizontal.range", "Valor" },

			{ "bar.horizontal-stacked.title", "Gr�fico con pilas de barras horizontales" },
			{ "bar.horizontal-stacked.domain", "Categor�as" }, { "bar.horizontal-stacked.range", "Valor" },

			{ "bar.vertical.title", "Gr�fico de barras verticales" }, { "bar.vertical.domain", "Categor�as" },
			{ "bar.vertical.range", "Valor" },

			{ "bar.vertical3D.title", "Gr�fico de barra vertical en 3D" }, { "bar.vertical3D.domain", "Categor�as" },
			{ "bar.vertical3D.range", "Valor" },

			{ "bar.vertical-stacked.title", "Gr�fico con pilas de barras verticales" },
			{ "bar.vertical-stacked.domain", "Categor�as" }, { "bar.vertical-stacked.range", "Valor" },

			{ "bar.vertical-stacked3D.title", "Gr�fico de barras verticales en 3D" },
			{ "bar.vertical-stacked3D.domain", "Categor�as" }, { "bar.vertical-stacked3D.range", "Valor" },

			{ "pie.pie1.title", "Gr�fico circular 1" },

			{ "pie.pie2.title", "Gr�fico circular 2" },

			{ "xyplot.sample1.title", "Plan de XY" }, { "xyplot.sample1.domain", "Valores de X" },
			{ "xyplot.sample1.range", "Valores de Y" },

			{ "timeseries.sample1.title", "Gr�fico con series de tiempo 1" },
			{ "timeseries.sample1.subtitle", "Valor de GBP en JPY" }, { "timeseries.sample1.domain", "Fecha" },
			...
			{ "timeseries.sample2.domain", "Milisegundo" }, { "timeseries.sample2.range", "Eje tronco" },
			{ "timeseries.sample2.subtitle", "Milisegundos" },

			{ "timeseries.sample3.title", "gr�fico con series de tiempo moviendo al promedio" },
			{ "timeseries.sample3.domain", "Fecha" }, { "timeseries.sample3.range", "CCY por GBP" },
			{ "timeseries.sample3.subtitle", "30 dias moviendo de GBP" },
			// GEEK
			{ "timeseries.highlow.title", "Gr�fico Alto/Bajo/Abierto/Cerrado" },
			{ "timeseries.highlow.domain", "Fecha" }, { "timeseries.highlow.range", "Precio  ($ por porci�n)" },
			{ "timeseries.highlow.subtitle", "Precio de la acci�n IBM" },

			{ "timeseries.candlestick.title", "Gr�fico de cotizaci�n" }, { "timeseries.candlestick.domain", "Fecha" },
			{ "timeseries.candlestick.range", "Precio  ($ por porci�n)" },
			{ "timeseries.candlestick.subtitle", "Precio de la acci�n IBM" },

			{ "timeseries.signal.title", "Gr�fico de se�al" }, { "timeseries.signal.domain", "Fecha" },
			{ "timeseries.signal.range", "Precio  ($ por porci�n" },
			{ "timeseries.signal.subtitle", "Precio de la acci�n IBM" },

			{ "other.wind.title", "Plan de Viento" }, { "other.wind.domain", "eje-X" }, { "other.wind.range", "eje-Y" },

			{ "other.scatter.title", "Plan Esparcido" }, { "other.scatter.domain", "eje-X" },
			{ "other.scatter.range", "eje-Y" },

			{ "other.line.title", "Plan de l�nea" }, { "other.line.domain", "Categor�a" },
			{ "other.line.range", "Valor" },

			{ "other.xybar.title", "Gr�fico con barras y series de tiempo" }, { "other.xybar.domain", "Fecha" },
			{ "other.xybar.range", "Valor" },

			{ "test.null.title", "Plan XY (Nula data)" }, { "test.null.domain", "eje-X" },
			{ "test.null.range", "eje-Y" },

			{ "test.zero.title", "Plan XY (Cero data)" }, { "test.zero.domain", "eje-X" },
			{ "test.zero.range", "eje-Y" },

			{ "test.scroll.title", "Series de tiempo" }, { "test.scroll.subtitle", "Valor of GBP" },
			{ "test.scroll.domain", "Fecha" }, { "test.scroll.range", "Valor" },

			{ "test.single.title", "Gr�fico de barras de series �nicas" }, { "test.single.subtitle1", "Subt�tulo 1" },
			{ "test.single.subtitle2", "Subt�tulo 2" }, { "test.single.domain", "Fecha" },
			{ "test.single.range", "Valor" },

			{ "test.dynamic.title", "Gr�fico din�mico" }, { "test.dynamic.domain", "Dominios" },
			...
			{ "combined.overlaid.domain", "Fecha" }, { "combined.overlaid.range", "IBM" },
			...
			{ "combined.vertical.subtitle", "Cuatro gr�ficos en uno" }, { "combined.vertical.domain", "Fecha" },
			...
			{ "combined.combined-overlaid.subtitle",
					"XY, cubierto(dos series de tiempo) y cubierto " + "(Alto Bajo y series de tiempo)" },
			...
			{ "combined.dynamic.subtitle",
					"XY (series 0), XY (serie 1), cubierto (ambas series)) " + "y XY (ambas series)" },
