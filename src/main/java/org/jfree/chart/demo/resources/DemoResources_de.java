 ...
 * $Id: DemoResources_de.java,v 1.3 2010/12/14 09:27:16 morla Exp $
 * Changes
 * -------
...
public class DemoResources_de extends ListResourceBundle {
	...
	private static final Object[][] CONTENTS = {
			...
			{ "tab.bar", "Balkendiagramme" }, { "tab.pie", "Kreisdiagramme" }, { "tab.xy", "XY-Diagramme" },
			{ "tab.time", "Zeitreihen-Diagramme" }, { "tab.other", "Andere Diagramme" },
			{ "tab.test", "Testdiagramme" }, { "tab.combined", "Kombinierte Diagramme" },
			
			// sample chart descriptions...
			{ "chart1.title", "Horizontales Balkendiagrammet: " },
			{ "chart1.description",
					"Anzeige eines horizontalen Balkendiagramms mit den Daten eines "
							+ "CategoryDataset. Die numerische Achse ist invertiert." },
			
			{ "chart2.title", "Horizontales Stacked Balkendiagramm: " },
			{ "chart2.description",
					"Anzeige eines horizontalen stacked Balkediagramms mit den Daten " + "eines CategoryDataset." },
			
			{ "chart3.title", "Vertikales Balkendiagrammt: " },
			{ "chart3.description",
					"Anzeige eines vertikalen Balkendiagramms mit den Daten eines " + "CategoryDataset." },
			
			{ "chart4.title", "Vertikales 3D Balkendiagramm: " },
			{ "chart4.description",
					"Anzeige eines vertikalen 3D Balkendiagramms mit den Daten eines " + "CategoryDataset." },
			...
			{ "chart20.title", "Null Daten: " }, { "chart20.description", "A chart with a null dataset." },
			...
			{ "chart25.description",
					"Anzeige eines overlaid chart with high/low/open/close and moving " + "average plots." },
			
			{ "chart26.title", "Horizontales Kombi-Diagramm: " },
			{ "chart26.description",
					"Anzeige eines horizontally combined chart of time series and " + "XY bar plots." },
			
			{ "chart27.title", "Vertikales Kombi-Diagramm: " },
			{ "chart27.description",
					"Ein vertikal kominiertes Diagramm eines XY-Diagramms, TimeSeries "
							+ "und eines VerticalXYBar-plots" },
			
			{ "chart28.title", "Kombi- und Overlaid-Diagramm: " },
			{ "chart28.description",
					"Ein kominiertes Diagramm eines XY-Diagramms, overlaid TimeSeries- "
							+ "und eines HighLow & TimeSeries-plots" },
			
			{ "chart29.title", "Kombi- und Overlaid Dynamisches Diagramm: " },
			{ "chart29.description",
					"Anzeige eines dynamisch kombinierten und overlaid Diagramm, um "
							+ "den event Benachrichtigungs-Mechanismus zu testen." },
			
			{ "charts.display", "Anzeige" },
			
			// chart titles and labels...
			{ "bar.horizontal.title", "Horizontales Balkendiagramm" }, { "bar.horizontal.domain", "Kategorien" },
			{ "bar.horizontal.range", "Werte" },
			
			{ "bar.horizontal-stacked.title", "Horizontal Stacked Balkendiagramm" },
			{ "bar.horizontal-stacked.domain", "Kategorien" }, { "bar.horizontal-stacked.range", "Werte" },
			
			{ "bar.vertical.title", "Vertikales Balkendiagramm" }, { "bar.vertical.domain", "Kategorien" },
			{ "bar.vertical.range", "Werte" },
			
			{ "bar.vertical3D.title", "Vertikales Balkendiagramm" }, { "bar.vertical3D.domain", "Kategorien" },
			{ "bar.vertical3D.range", "Werte" },
			
			{ "bar.vertical-stacked.title", "Vertikales Balkendiagramm" },
			{ "bar.vertical-stacked.domain", "Kategorien" }, { "bar.vertical-stacked.range", "Werte" },
			
			{ "bar.vertical-stacked3D.title", "Vertikales Balkendiagramm" },
			{ "bar.vertical-stacked3D.domain", "Kategorien" }, { "bar.vertical-stacked3D.range", "Werte" },
			
			{ "pie.pie1.title", "Kreisdiagramm 1" },
			
			{ "pie.pie2.title", "Kreisdiagramm 2" },
			
			{ "xyplot.sample1.title", "XY Plot" }, { "xyplot.sample1.domain", "X Werte" },
			...
			{ "timeseries.sample1.domain", "Datum" }, { "timeseries.sample1.range", "CCY pro GBP" },
			{ "timeseries.sample1.copyright", "(C)opyright 2002, by Object Refinery Limited" },
			
			{ "timeseries.sample2.title", "Zeitreihen Diagramm 2" }, { "timeseries.sample2.domain", "Millisekunden" },
			{ "timeseries.sample2.range", "Log Achse" }, { "timeseries.sample2.subtitle", "Millisekunden" },
			...
			{ "timeseries.sample3.domain", "Datum" }, { "timeseries.sample3.range", "CCY pro GBP" },
			...
			{ "timeseries.highlow.title", "High/Low/Open/Close Diagramm" }, { "timeseries.highlow.domain", "Datum" },
			...
			{ "timeseries.candlestick.title", "CandleStick Diagramm" }, { "timeseries.candlestick.domain", "Datum" },
			...
			{ "timeseries.signal.title", "Signal Diagramm" }, { "timeseries.signal.domain", "Datum" },
			...
			{ "other.wind.title", "Wind Plot" }, { "other.wind.domain", "X-Achse" }, { "other.wind.range", "Y-Achse" },
			
			{ "other.scatter.title", "Scatter Plot" }, { "other.scatter.domain", "X-Achse" },
			{ "other.scatter.range", "Y-Achse" },
			
			{ "other.line.title", "Linien Plot" }, { "other.line.domain", "Kategorie" }, { "other.line.range", "Wert" },
			
			{ "other.xybar.title", "Zeitreihen Balkendiagramm" }, { "other.xybar.domain", "Datum" },
			{ "other.xybar.range", "Value" },
			
			{ "test.null.title", "XY Plot (null data)" }, { "test.null.domain", "X" }, { "test.null.range", "Y" },
			
			{ "test.zero.title", "XY Plot (keine Daten)" }, { "test.zero.domain", "X-Achse" },
			{ "test.zero.range", "Y-Achse" },
			
			{ "test.scroll.title", "Zeitreihen" }, { "test.scroll.subtitle", "Wert von GBP" }, // not sure if this is
			// correct
			{ "test.scroll.domain", "Datum" }, { "test.scroll.range", "Wert" },
			
			{ "test.single.title", "Einzelserien Balkendiagramm" }, { "test.single.subtitle1", "Subtitel 1" },
			{ "test.single.subtitle2", "Subtitel 2" }, { "test.single.domain", "Datum" },
			{ "test.single.range", "Wert" },
			
			{ "test.dynamic.title", "Dynamisches Diagramm" }, { "test.dynamic.domain", "Wertebereich" },
			...
			// not sure if this is correct
			{ "combined.overlaid.domain", "Datum" }, { "combined.overlaid.range", "IBM" },
			...
			{ "combined.vertical.subtitle", "Vier Diagramme in einem" }, { "combined.vertical.domain", "Datum" },
			...
			{ "combined.combined-overlaid.subtitle",
					"XY, Overlaid (zwei TimeSeries) und Overlaid " + "(HighLow und TimeSeries)" },
