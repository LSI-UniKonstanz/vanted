 ...
 * Contributor(s): -;
 * $Id: DemoResources_fr.java,v 1.3 2010/12/14 09:27:16 morla Exp $
 * Changes
 * -------
...
public class DemoResources_fr extends ListResourceBundle {
	...
	private static final Object[][] CONTENTS = {
			...
			// about frame...
			{ "about.title", "A propos de..." }, { "about.version.label", "Version" },

			// menu labels...
			{ "menu.file", "Fichier" }, { "menu.file.mnemonic", Character.valueOf('F') },

			{ "menu.file.exit", "Sortie" }, { "menu.file.exit.mnemonic", Character.valueOf('x') },

			{ "menu.help", "Aide" }, { "menu.help.mnemonic", Character.valueOf('H') },

			{ "menu.help.about", "A propos de..." }, { "menu.help.about.mnemonic", Character.valueOf('A') },
			...
			{ "tab.bar", "Diagrammes en Barre" }, { "tab.pie", "Diagrammes en Secteur" }, { "tab.xy", "Diagrammes XY" },
			{ "tab.time", "Diagrammes de S�ries Temporelles" }, { "tab.other", "Autres Diagrammes" },
			{ "tab.test", "Diagrammes de Test" }, { "tab.combined", "Diagrammes Combin�s" },

			// sample chart descriptions...
			{ "chart1.title", "Diagramme en Barre Horizontale: " },
			{ "chart1.description",
					"Affiche des barre horizontale � partir des donn�es "
							+ "d'un CategoryDataset. Remarquez que l'axe num�rique est invers�." },

			{ "chart2.title", "Diagramme en Barre Empil�e Horizontale: " },
			{ "chart2.description",
					"Affiche des barres empil�es horizontales � partir des donn�es " + "d'un CategoryDataset." },

			{ "chart3.title", "Diagramme en Barre Verticale: " },
			{ "chart3.description", "Affiche des barres verticales � partir des donn�es d'un CategoryDataset." },

			{ "chart4.title", "Diagramme en Barre 3D Verticale: " },
			{ "chart4.description",
					"Affiche des barres verticales avec un effet 3D � partir des donn�es " + "d'un CategoryDataset." },

			{ "chart5.title", "Diagramme en Barre Empil�e Verticale: " },
			{ "chart5.description",
					"Affiche des barres empil�es verticale � partir des donn�es " + "d'un CategoryDataset." },
			...
			{ "chart9.description",
					"Un diagramme en ligne � partir de donn�es d'un XYDataset. Les deux axes sont " + "num�riques." },
			...
			{ "chart14.description", "Un diagramme en Chandelier bas� sur les donn�es d'un HighLowDataset." },
			...
			{ "chart18.description",
					"Un diagramme affichant des lignes ou des formes � partir des donn�es "
							...
							+ "d'une image de fond sur le diagramme, et de l'alpha-transparence sur le " + "trac�." },

			{ "chart19.title", "Diagramme en Barre XY Verticale: " },
			{ "chart19.description",
					"Un diagramme avec des barres verticales, bas� sur des donn�es " + "d'un IntervalXYDataset." },
			...
			{ "chart21.description", "Diagramme � partir d'un ensemble de donn�es contenant des s�ries de z�ros." },
			...
			{ "bar.horizontal.title", "Diagramme en Barre Horizontale" }, { "bar.horizontal.domain", "Cat�gories" },
			{ "bar.horizontal.range", "Valeur" },

			{ "bar.horizontal-stacked.title", "Diagramme en Barre Empil�e Horizontale" },
			{ "bar.horizontal-stacked.domain", "Cat�gories" }, { "bar.horizontal-stacked.range", "Valeur" },

			{ "bar.vertical.title", "Diagramme en Barre Verticale" }, { "bar.vertical.domain", "Cat�gories" },
			{ "bar.vertical.range", "Valeur" },

			{ "bar.vertical3D.title", "Diagramme en Barre 3D Verticale" }, { "bar.vertical3D.domain", "Cat�gories" },
			{ "bar.vertical3D.range", "Valeur" },

			{ "bar.vertical-stacked.title", "Diagramme en Barre Empil�e Verticale" },
			{ "bar.vertical-stacked.domain", "Cat�gories" }, { "bar.vertical-stacked.range", "Valeur" },

			{ "bar.vertical-stacked3D.title", "Diagramme en Barre 3D Empil�e Verticale" },
			{ "bar.vertical-stacked3D.domain", "Cat�gories" }, { "bar.vertical-stacked3D.range", "Valeur" },

			{ "pie.pie1.title", "Diagramme en Secteur 1" },

			{ "pie.pie2.title", "Diagramme en Secteur 2" },

			{ "xyplot.sample1.title", "Trac� XY" }, { "xyplot.sample1.domain", "Valeurs X" },
			{ "xyplot.sample1.range", "Valeurs Y" },

			{ "timeseries.sample1.title", "Diagramme de S�ries Temporelles 1" },
			{ "timeseries.sample1.subtitle", "Valeur du GBP pour le JPY" }, { "timeseries.sample1.domain", "Date" },
			...
			{ "timeseries.sample2.domain", "Milliseconde" }, { "timeseries.sample2.range", "Axes Logarithmique" },
			{ "timeseries.sample2.subtitle", "Millisecondes" },

			{ "timeseries.sample3.title", "Diagramme de S�ries Temporelles avec Moyenne Mobile" },
			{ "timeseries.sample3.domain", "Date" }, { "timeseries.sample3.range", "CCY par GBP" },
			...
			{ "timeseries.highlow.domain", "Date" }, { "timeseries.highlow.range", "Prix ($ par action)" },
			{ "timeseries.highlow.subtitle", "Prix des actions IBM" },

			{ "timeseries.candlestick.title", "Diagramme en Chandelier" }, { "timeseries.candlestick.domain", "Date" },
			{ "timeseries.candlestick.range", "Prix ($ par action)" },
			{ "timeseries.candlestick.subtitle", "Prix des actions IBM" },

			{ "timeseries.signal.title", "Diagramme en Signal" }, { "timeseries.signal.domain", "Date" },
			{ "timeseries.signal.range", "Prix ($ par action)" },
			{ "timeseries.signal.subtitle", "Prix des actions IBM" },

			{ "other.wind.title", "Trac� de Vents" }, { "other.wind.domain", "Axe X" }, { "other.wind.range", "Axe Y" },

			{ "other.scatter.title", "Nuage de Points" }, { "other.scatter.domain", "Axe X" },
			{ "other.scatter.range", "Axe Y" },

			{ "other.line.title", "Diagramme en Ligne" }, { "other.line.domain", "Cat�gorie" },
			{ "other.line.range", "Valeur" },

			{ "other.xybar.title", "Diagramme en Barre de S�ries Temporelles" }, { "other.xybar.domain", "Date" },
			{ "other.xybar.range", "Valeur" },

			{ "test.null.title", "Trac� XY (donn�es nulle)" }, { "test.null.domain", "X" }, { "test.null.range", "Y" },

			{ "test.zero.title", "Trac� XY (donn�es z�ros)" }, { "test.zero.domain", "Axe X" },
			{ "test.zero.range", "Axe Y" },

			{ "test.scroll.title", "S�rie Temporelle" }, { "test.scroll.subtitle", "Valeur du GBP" },
			{ "test.scroll.domain", "Date" }, { "test.scroll.range", "Valeur" },

			{ "test.single.title", "Diagramme en Barre avec S�rie Unique" },
			{ "test.single.subtitle1", "Sous-titre 1" }, { "test.single.subtitle2", "Sous-titre 2" },
			{ "test.single.domain", "Date" }, { "test.single.range", "Valeur" },

			{ "test.dynamic.title", "Diagramme dynamique" }, { "test.dynamic.domain", "Domaine" },
			...
			{ "combined.vertical.subtitle", "Quatre diagramme en un" }, { "combined.vertical.domain", "Date" },
			...
			{ "combined.combined-overlaid.subtitle",
					"XY, Superpos� (2 TimeSeriess) et Superpos� " + "(HighLow et TimeSeries)" },
			...
			{ "combined.dynamic.subtitle",
					"XY (s�ries 0), XY (s�ries 1), Superpos� (les deux s�ries) " + "et XY (les deux s�ries)" },
