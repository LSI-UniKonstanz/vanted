...
public class SymbolicYPlotDemo {
	 ...
	 *           dataset 2.
	 */
	private static void displayYSymbolicCombinedVertically(final String frameTitle, final SampleYSymbolicDataset data1,
	 ...
	 *           the data.
	 * @param legend
	 *           a flag controlling whether or not the legend is created for the
	 *           chart.
	 * @return the chart.
	 */
	public static JFreeChart createYSymbolicPlot(final String title, final String xAxisLabel, final String yAxisLabel,
	...
	public static void main(final String[] args) {
		...
		displayYSymbolicOverlaid("Example 5", (SampleYSymbolicDataset) s1.clone(), (SampleYSymbolicDataset) s2.clone());
	}
