 ...
 * Contributor(s): -;
 * $Id: SurveyResultsDemo.java,v 1.3 2010/12/14 09:27:16 morla Exp $
 * Changes
 * -------
...
public class SurveyResultsDemo extends ApplicationFrame {
	...
	private JFreeChart createChart(final CategoryDataset dataset) {
		...
		final CategoryTextAnnotation a2 = new CategoryTextAnnotation(
				"2. White papers enhance users " + "understanding of the firm and its expertise.", "Category 2", 0.0);
		...
		final CategoryTextAnnotation a6 = new CategoryTextAnnotation(
				"6. Case studies enhance users " + "understanding of the firm and its expertise.", "Category 6", 0.0);
		...
		final CategoryTextAnnotation a10 = new CategoryTextAnnotation(
				"10. Case studies enhance users " + "understanding of the firm and its expertise.", "Category 10", 0.0);
