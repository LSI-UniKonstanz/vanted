 ...
 * $Id: CategoryItemEntity.java,v 1.2 2010/12/14 07:02:06 morla Exp $
 * Changes:
 * --------
 ...
 * 20-May-2004 : Added equals() and clone() methods, and implemented Serializable (DG);
 */
...
public class CategoryItemEntity extends ChartEntity implements Cloneable, Serializable {
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof CategoryItemEntity && super.equals(obj)) {
			...
			if (!ObjectUtils.equal(this.category, cie.category)) {
				return false;
			}
			return true;
		}
