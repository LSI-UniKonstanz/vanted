 ...
 * $Id: Timeline.java,v 1.2 2010/12/14 07:02:00 morla Exp $
 * Changes
 * -------
 ...
 * values. In theory many transformations are possible. This interface has been implemented completely in {@link org.jfree.chart.axis.SegmentedTimeline}.
 * <P>
 * A timeline can be used as parameter to a {@link org.jfree.chart.axis.DateAxis} to define the values that this axis supports. As an example, the
 * {@link org.jfree.chart.axis.SegmentedTimeline} implements a timeline formed by segments of equal length (ex. days, hours, minutes) where some segments can be
 * included in the timeline and others excluded. Therefore timelines like "working days" or "working hours" can be created where non-working days or non-working
 * hours respectively can be removed from the timeline, and therefore from the axis. This creates a smooth plot with equal separation between all included
 * segments.
 * <P>
