 ...
 * Contributor(s): -;
 * $Id: DateTickUnit.java,v 1.2 2010/12/14 07:02:00 morla Exp $
 * Changes (from 8-Nov-2002)
 * --------------------------
 * 08-Nov-2002 : Moved to new package com.jrefinery.chart.axis (DG);
 * 27-Nov-2002 : Added IllegalArgumentException to getMillisecondCount(...) method (DG);
 * 26-Mar-2003 : Implemented Serializable (DG);
 * 12-Nov-2003 : Added roll fields that can improve the labelling on segmented date axes (DG);
 * 03-Dec-2003 : DateFormat constructor argument is now filled with an default if null (TM);
	...
	public boolean equals(Object obj) {
		...
		if (obj instanceof DateTickUnit) {
			...
			if (super.equals(obj)) {
				...
				boolean b1 = ObjectUtils.equal(this.formatter, dtu.formatter);
				return b0 && b1;
			} else {
				return false;
			}
