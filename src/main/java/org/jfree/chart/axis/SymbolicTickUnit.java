 ...
 * $Id: SymbolicTickUnit.java,v 1.2 2010/12/14 07:02:00 morla Exp $
 * Changes
 * -------
 ...
 * 03-Dec-2003 : There is no need for using lists here; replaced by String-array (TM);
 */
...
public class SymbolicTickUnit extends NumberTickUnit implements Serializable {
	 ...
	 * @param sv
	 *           the list of symbolic value to display instead of the numeric value.
	 */
