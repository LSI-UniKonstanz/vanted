 ...
 * Nicolas Brodu;
 * Barak Naveh;
 * $Id: Legend.java,v 1.2 2010/12/14 07:02:07 morla Exp $
...
public abstract class Legend implements Serializable, Cloneable {
	 ...
	 * 
	 * @return <code>true</code> if and only if this legend is anchored to middle.
	 */
	 ...
	 * 
	 * @return <code>true</code> if and only if this legend is anchored to bottom.
	 */
	 ...
	 * 
	 * @return <code>true</code> if and only if this legend is anchored to right.
	 */
	 ...
	 * 
	 * @return <code>true</code> if and only if this legend is anchored to center.
	 */
