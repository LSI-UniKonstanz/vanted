 ...
 * $Id: LogConfiguration.java,v 1.2 2010/12/14 07:02:05 morla Exp $
 * Changes
 * -------
...
public class LogConfiguration {
	...
	public static void setLogTarget(final String logTarget) {
		BaseBoot.getInstance().getGlobalConfig().setConfigProperty
							(LOGTARGET, logTarget);
	}
	 ...
	 * <li>changing the log level after the {@link org.jfree.util.Log} class has been loaded will have no effect.</li>
	...
	public static void setLogLevel(final String level) {
		BaseBoot.getInstance().getGlobalConfig().setConfigProperty(LOGLEVEL, level);
	}
