 ...
 * $Id: AbstractModule.java,v 1.2 2010/12/14 07:02:02 morla Exp $
 * Changes
 * -------
 ...
 * <p>
 * The module can be specified in an external property file. The file name of this specification defaults to "module.properties". This file is no real property
 * file, it follows a more complex rule set.
 * <p>
 * Lines starting with '#' are considered comments. Section headers start at the beginning of the line, section properties are indented with at least one
 * whitespace.
 * <p>
 ...
 * </pre>
 * 
 * The properties name, producer and description are simple strings. They may span multiple lines, but may not contain a colon (':'). The version properties are
 * integer values.
 * <p>
 * This section may be followed by one or more "depends" sections. These sections describe the base modules that are required to be active to make this module
 * work. The package manager will enforce this policy and will deactivate this module if one of the base modules is missing.
 * <p>
 * 
 * <pre>
 * depends:
...
public abstract class AbstractModule extends DefaultModuleInfo implements Module {
	 ...
	 * 
	 * @param reader
	 *           the reader from where to read.
	 * @param firstLine
	 *           the first line (which was read elsewhere).
	 ...
	 * 
	 * @param reader
	 *           the reader from where to read the content.
	 * @throws IOException
	 *            if an error occures
	 */
	 ...
	 * 
	 * @param reader
	 *           the reader from where to read the module
