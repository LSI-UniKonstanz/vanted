 ...
 * $Id: PackageManager.java,v 1.2 2010/12/14 07:02:02 morla Exp $
 * Changes
 * -------
 ...
 * provides a very strict way of removing unnecessary dependencies beween the various packages.
 * <p>
...
public final class PackageManager {
	...
	public void load(final String modulePrefix) {
		...
		final ModifiableConfiguration config = this.booter.getGlobalConfig();
	 ...
	 * @param module
	 *           the module specification that is checked.
	 ...
	 * 
	 * @param moduleInfo
	 *           the module info of the module that should be loaded.
	 ...
	 *           be completly loaded.
	 * @param modules
	 *           the list of previously loaded modules for this module.
	 * @param fatal
	 ...
	 * information.
	 * 
	 * @param moduleRequirement
	 *           the required module specification.
	 * @param module
	 *           the module that should be checked against the specification.
	 ...
	 * @param depModVer
	 *           the version string of the dependent or optional module
