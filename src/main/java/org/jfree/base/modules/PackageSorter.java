 ...
 * $Id: PackageSorter.java,v 1.2 2010/12/14 07:02:02 morla Exp $
 * Changes
 * -------
 ...
 * <p>
 * When sorting, we match this modules position against all dependent modules until all positions are stable. Circular references are evil and are filtered
 * during the module loading process in the package manager.
 * 
...
public final class PackageSorter {
	...
	private static class SortModule implements Comparable {
		 ...
		 * @param o
		 *           the other sort module instance.
	 ...
	 * 
	 * @param smodule
	 *           the sort module for that we compute the new positon.
	 * @param moduleMap
