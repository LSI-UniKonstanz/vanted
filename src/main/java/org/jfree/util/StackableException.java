 ...
 * $Id: StackableException.java,v 1.2 2010/12/14 07:02:00 morla Exp $
 * Changes
 * -------
 ...
 * <p>
 * The parents are printed when this exception is printed. This class exists mainly for debugging reasons, as with them it is easier to detect the root cause of
 * an error. <!-- In a perfect world there would be no need for such a class :)-->
 * 
...
public abstract class StackableException extends Exception {
	 ...
	 * standard error stream. This method prints a stack trace for this <code>Throwable</code> object on the error output stream that is
