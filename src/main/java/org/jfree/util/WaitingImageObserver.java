 ...
 * $Id: WaitingImageObserver.java,v 1.2 2010/12/14 07:02:00 morla Exp $
...
public class WaitingImageObserver implements ImageObserver, Serializable, Cloneable {
	...
	/**
	 * Creates a new <code>ImageObserver<code> for the given <code>Image<code>. The observer has to 
   * be started by an external thread.
	 * 
	 * @param image
	 *           the image to observe (<code>null</code> not permitted).
	 */
	 ...
	 *           flags: <code>WIDTH</code>, <code>HEIGHT</code>, <code>PROPERTIES</code>, <code>SOMEBITS</code>, <code>FRAMEBITS</code>, <code>ALLBITS</code>,
