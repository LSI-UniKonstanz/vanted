 ...
 * Contributor(s): -;
 * $Id: DayAndMonthRule.java,v 1.2 2010/12/14 07:02:02 morla Exp $
 ...
 */
public class DayAndMonthRule extends AnnualDateRule implements Cloneable {
	 ...
	 * <P>
	 * For the month parameter, use SerialDate.JANUARY, etc. Note that there are no checks to prevent you from entering an invalid combination (such as 31
	 * February).
	 * 
	 * @param dayOfMonth
