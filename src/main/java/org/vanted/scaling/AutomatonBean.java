...
/**
 * This introduces states in terms of the scaling work flow. It is
 * useful for synchronizing scaling events on special components, which
 ...
 * <b>unscaled</b>: initial property value; could go to <i>onSlider</i>, <i>onStart</i>.<br>
 * <b>onStart</b>: scaled on application start-up; could go to <i>idle</i>.<br>
 * <b>onSlider</b>: scaled with the slider while application running; could go to <i>unscaled</i>, <i>rescaled</i>, <i>idle</i>.<br>
 * <b>rescaled</b>: re-scaling with the same slider instance; could go to <i>onSlider</i>, <i>idle</i>.<br>
 * <b>idle</b>: after scaling is done and custom DPI is established; could go to <i>onSlider</i>.<br>
 * @author dim8
 *
 */
