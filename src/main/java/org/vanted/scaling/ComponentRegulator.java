...
public class ComponentRegulator {
	 ...
	 * 
	 * @param scaleFactor
	 *           the working scaling factor, a ratio between current actual
	 ...
	 * 
	 * @param container,
	 *           application main frame/window/container
	 * @throws OutOfMemoryError
	 *            when the allocated heap memory is not enough to hold
...
//		}
	 ...
	 * @param container
	 * @param checkScaled
	 *           true to check components for being scaled and avoid double
	 *           scaling
	 * @param mark
	 ...
	 * 
	 * @param superclass
	 *           the super class, or possibly even direct class for
	 *           overriding purposes.
	 * @param scaler
