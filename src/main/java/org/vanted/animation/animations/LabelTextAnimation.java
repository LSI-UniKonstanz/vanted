...
public class LabelTextAnimation extends Animation<StringTimePoint> {
	...
	public LabelTextAnimation(Edge attributable, List<StringTimePoint> dataPoints, double loopDuration, double startTime, int noLoops, Looper looper) {
		super(attributable, dataPoints, loopDuration, startTime, noLoops, looper);
		// TODO Auto-generated constructor stub
	}

	public LabelTextAnimation(Edge attributable, List<StringTimePoint> dataPoints, double loopDuration, double startTime, int noLoops) {
		super(attributable, dataPoints, loopDuration, startTime, noLoops);
		// TODO Auto-generated constructor stub
	}

	public LabelTextAnimation(Edge attributable, List<StringTimePoint> dataPoints, double loopDuration, double startTime) {
