...
public class PositionYAnimation extends ContinuousAnimation<DoubleTimePoint> {
	public PositionYAnimation(Attributable attributable, List<DoubleTimePoint> dataPoints, double loopDuration, double startTime, int noLoops, Looper looper,
	...
	public PositionYAnimation(Attributable attributable, List<DoubleTimePoint> dataPoints, double loopDuration, double startTime, int noLoops) {
		super(attributable, dataPoints, loopDuration, startTime, noLoops);
		// TODO Auto-generated constructor stub
	}

	public PositionYAnimation(Attributable attributable, List<DoubleTimePoint> dataPoints, double loopDuration, double startTime) {
