...
public class VisibilityAnimation extends Animation<BooleanTimePoint>{
	 ...
	 * @param looper
	 */
	public VisibilityAnimation(Attributable attributable, List<BooleanTimePoint> dataPoints, double loopDuration, double startTime, int noLoops,
			Looper looper) {
	 ...
	 * @param startTime
	 */
	public VisibilityAnimation(Attributable attributable, List<BooleanTimePoint> dataPoints, double loopDuration, double startTime) {
