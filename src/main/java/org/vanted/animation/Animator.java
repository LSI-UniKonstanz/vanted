...
public class Animator {
	...
	public void initialliseTestAnimation()
	{
		...
		for (int i = 0; i < nodes.size(); i++)
		{
			...
			Position2DAnimation posAnim = new Position2DAnimation(node, 0, animationDuration, new BezierInterpolator(), Arrays.asList(pointsArray), 1,
					LoopType.forward);
//			FillColorAnimation fillAnim = new FillColorAnimation(node, 0, animationDuration, new BezierInterpolator(), Arrays.asList(fillArray), -1,
//					LoopType.swing, ColorMode.rgb);
...
//			OutlineColorAnimation outlineColourAnim = new OutlineColorAnimation(node, 0, animationDuration, new LinearInterpolator(), Arrays.asList(outlineArray),
//					-1, LoopType.swing, ColorMode.rgb);
//			LabelColorAnimation labelColourAnim = new LabelColorAnimation(node, 0, animationDuration, new LinearInterpolator(), Arrays.asList(labelColourArray),
//					-1, -1, LoopType.swing, ColorMode.hsb);
//			FrameThicknessAnimation thicknessAnim = new FrameThicknessAnimation(node, 0, animationDuration, new LinearInterpolator(),
//					Arrays.asList(thicknessArray), -1, LoopType.swing);
...
//			addAnimation(fillAnim);
		...
		for (int i = 0; i < edges.size(); i++)
		{
			...
			OutlineColorAnimation outlineColourAnim = new OutlineColorAnimation(edge, 0, animationDuration, new LinearInterpolator(), Arrays.asList(colours), -1,
					LoopType.swing, ColorMode.rgb);
			FrameThicknessAnimation thicknessAnim = new FrameThicknessAnimation(edge, 0, animationDuration, new CosineInterpolator(), Arrays.asList(thickness),
					-1, LoopType.swing);
			//addAnimation(thicknessAnim);
			//addAnimation(outlineColourAnim);
		}
