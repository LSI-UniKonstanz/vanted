 ...
 * 
 * @author - Patrick Shaw
 * Interpolates data between the first half a period of a cosine graph.<br>
 * In position animations, it will cause the animation to start off slow,
 * speed up and slow down again everytime it goes from one data point to the other.<br>
