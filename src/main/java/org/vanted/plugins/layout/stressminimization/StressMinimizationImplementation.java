...
class StressMinimizationImplementation {
	 ...
	 *           The nodes to layout.
	 * @param callingLayout
	 *           The StressMinimizationLayout instance creating this instance
	 * @param numberOfLandmarks
	 * @param alpha
	 *           alpha exponent for weighting.
	 * @param stressChangeEpsilon
	 *           Stress change threshold below which execution will be terminated
	 * @param initialStressPercentage
	 *           The initial stress percentage below which execution will be
	 *           terminated
	 * @param minimumNodeMovementThreshold
	 *           The minimum node movement threshold below which execution will be
	 *           terminated
	 * @param iterationsThreshold
	 *           The maximal number of iterations above which execution will be
	 *           terminated
	 */
	 ...
	 *
	 * @param prevStress
	 *           Stress of the previous layout
	 * @param newStress
	 *           Stress of the updated layout
	 * @param layout
	 *           The new layout
	 * @param interationCount
	 ...
	 * 
	 * @param numberOfAlreadySelectedLandmarks
	 *           Number of already selected landmarks
	 * @param landmarkToAllDistances
	 *           the distances from the previously selected landmarks to all other nodes
	 ...
	 *
	 * @param nodes
	 *           A list of nodes. For these nodes the distances to the other nodes in the set will be
	 *           calculated.
	 ...
	 */
	private RealMatrix positionNodesAtBarycentersOfLandmarks(final IndexedNodeSet landmarks, final RealMatrix landmarksToAllDistances,
			final RealMatrix landmarkLayout) {
		...
		for (int i : nodes) {
			...
			if (landmarks.isContainedBasisCollectionAndSet(node)) {
				...
				RealMatrix nodeLayout = nodesToLandmarksWeights.getRowMatrix(i)
