...
class StressMajorizationLayoutCalculator {
	 ...
	 * 
	 * @param layout
	 *           The current or initial layout: A two dimensional n*d matrix
	 *           where n is the number of nodes and d is the dimension (typically two).
	 * @param distances
	 *           The distance matrix (n*n matrix) with distance
	 *           of the nodes i and j at position i,j
	 * @param weights
	 *           The weight matrix (n*n matrix) with the weight for
	 ...
	 * 
	 * @param w
	 *           the weight matrix that should be the basis for the calculated weighted laplacian.
	 ...
	 * 
	 * @param w
	 *           the weight matrix the output matrix will be calculated from.
	 * @param d
	 *           the distance matrix the output matrix will be calculated from.
	 * @param Z
	 *           the "Z" matrix the output matrix will be calculated from.
