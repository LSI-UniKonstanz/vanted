...
/**
 * Initial prototype by mathiak in VantedPreferences. This is an extracted
 *  class from there. This version provides a bit more convenient way of 
 *  initialization and most of all it is <b>hashable</b>. It also proves
 *  to be a somewhat lighter version of LookAndFeelInfo.
 *  
 *  @version 1.1
 * 
 * @author mathiak
...
public class LookAndFeelNameAndClass {
	...
	public boolean equals(Object obj) {
		...
		return this.name.equals(lafnac.getName()) && 
				this.className.equals(lafnac.toString());
	}
