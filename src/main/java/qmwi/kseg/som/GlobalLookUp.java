...
/**
 * Globale Klasse, die alle Variationen an Eingaben speichert und einen Wert
 * zur�ckliefert, der Anzeigt, der wievielten Variante der Eingabe-String
 * entspricht (getEntry) Spalten werden unabh�ngig verwaltet
 */
class GlobalLookUp {
