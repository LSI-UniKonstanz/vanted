...
public class DiagrammPaneData extends javax.swing.table.AbstractTableModel {
	...
	/**
	 * Insert the method's description here. Creation date: (14.12.2001 13:16:03)
	 * 
	...
	public Object getValueAt(int row, int column) {
		...
		if (column == 0)
			...
			/*
			 * Aus.a("row",row); Aus.a("col",column);
			 * Aus.a("aAll.getCountClasses()",aAll.getCountClasses());
			 * Aus.a("aAll.getCountAttributs()",aAll.getCountAttributs());
			 * Aus.a("aAll.getClass(row).getAttribut(column).average",aAll.getClass(row).
	...
	/**
	 * Insert the method's description here. Creation date: (14.12.2001 12:49:34)
	 */
