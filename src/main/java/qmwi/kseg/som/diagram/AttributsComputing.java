...
/**
 * Insert the type's description here. Creation date: (14.12.2001 01:20:07)
 * 
 * @author:
 */
public class AttributsComputing {
	/**
	 * Insert the method's description here. Creation date: (16.12.2001 23:19:10)
	 */
			...
			for (int ia = 0; ia < ca.getCountAttributsSelected(); ia++) {
				...
				for (int io = 0; io < cc.getCountObjects(); io++) {
					...
					try {
						...
						// eine Zelle kann einen falschen Wert aufweisen, und mu�t daher besondert
						// behandelt werden
