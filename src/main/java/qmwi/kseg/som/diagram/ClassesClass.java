...
public class ClassesClass {
	...
	/**
	 * Euklidische Distanz: Wurzel aus der Summe der Quadrate der Abst�nde der
	 * Eigenschaften zweier Objekte Bsp: a | a1=2, a2=4 b | b1=4, b2=6 ED = Wurzel(
	 * (a1-b1)*(a1-b1) + (a2-b2)*(a2-b2) ) ED = Wurzel( (2-4)*(2-4) + (4-6)*(4-6) )
	...
	/**
	 * Homogenit�t ist die Summe der Euklidische Abst�nde zwischen den Objekten und
	 * dem Neuron Creation date: (13.12.2001 15:59:21)
	 * 
	 * @param i
	 *           int
	 * @param oneObject
