 ...
 * <p>
 * You can call {@link de.muntjak.tinylookandfeel.Theme#getAvailableThemes()} to get an array of <code>ThemeDescription</code> objects, each describing a unique
 * TinyLaF theme resource.
 * 
 * @author Hans Bickel
 * @version 1.0
 */
public class ThemeDescription {
	...
	/**
	 * Returns <code>true</code> if the <code>URI</code> or <code>URL</code> argument given at construction time was valid, <code>false</code> otherwise.
	 * 
	 * @return <code>true</code> if the <code>URI</code> or <code>URL</code> argument given at construction time was valid, <code>false</code> otherwise.
	 */
	 ...
	 * The returned string will be <code>null</code> if the <code>URL</code> or <code>URI</code> specified at construction time was invalid.
	 * 
	 ...
	 * argument given at construction time was a file URI/URL, <code>false</code> otherwise.
	 * 
