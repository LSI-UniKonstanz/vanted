...
public class TinySpinnerUI extends BasicSpinnerUI {
	 ...
	 * <p>
	 * Note that one instance of this handler is shared by all slider previous arrow buttons and likewise for all of the next buttons, so it doesn't have any
	 * state that persists beyond the limits of a single button pressed/released gesture.
	 */
