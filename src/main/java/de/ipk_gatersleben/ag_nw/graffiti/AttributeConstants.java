 ...
 * org.graffiti.attributes.GraphicAttributeConstants, which contains other Path
 * names. This is the newer file that should by used by our group (ag_nw). The
 * other class should be used only for graffiti internal path names, not for
 * pathnames that are used by the plugins.
 * 
 * @author klukas
