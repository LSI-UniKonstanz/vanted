 ...
 * @author Torsten Vogt
 * TODO: Alle anderen Zugriffe als dem Lesezugriff.
 */
public class RestService {
	...
	/**
	 * 
	 * @param baseUrl	Absoluter Pfad zu einer Webresource (Bsp.: "http://rest.kegg.jp/")
	 */
	...
	/**
	 * 
	 * @param path	Pfad ab der webRessource (Bsp.: "list/" ). Kann auch l�nger als ein Verzeichnis sein.
	 */
	...
	/**
	 * 
	 * @param path	Pfad ab der baseUrl. Array wird der Reihe nach ausgelesen (Bsp.; "kegg/" | "rest/" | ...).
	 */
	...
	/**
	 * 
	 * @param path	Bisheriger Verzeichnispfad wird verl�ngert.
	 */
	 ...
	 * @param pathAddition	Bei multiplen Anfragen an eine Adresse, nur den letzten Teil des Pfads angeben. (ansonsten leeren String)
	 * @param mediaType		MediaType der beim Download akzeptiert wird (Bsp.: MediaType.TEXT_PLAIN)
	 * @param cl			zu erwartende Klasse der Resource (Bsp.: String.class)
	 ...
	 * @param baseUrl		Absoluter Pfad zu einer Webresource (Bsp.: "http://rest.kegg.jp/")
	 * @param path			Pfad ab der baseUrl (Bsp.: "list/" ). Kann auch l�nger als ein Verzeichnis sein.
	 * @param mediaType		MediaType der beim Download akzeptiert wird (Bsp.: MediaType.TEXT_PLAIN)
	 * @param cl			zu erwartende Klasse der Resource (Bsp.: String.class)
	 * @return				Gibt Download als Object zur�ck (null, bei Fehlern)
	 */
