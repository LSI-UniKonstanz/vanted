...
public class SBMLNodesNiceIdHelper {
	...
	private static void initReactionNiceIDs() {
		...
		AttributeHelper.setNiceId(SBML_Constants.REACTION_ID, SBML_Constants.SBML_HEADLINE + ": ID");
		AttributeHelper.setNiceId(SBML_Constants.REACTION_NAME, SBML_Constants.SBML_HEADLINE + ": Name");
	...
	private static void initSpeciesNiceIDs() {
		...
		AttributeHelper.setNiceId(SBML_Constants.SPECIES_ID, SBML_Constants.SBML_HEADLINE + ": ID");
		AttributeHelper.setNiceId(SBML_Constants.SPECIES_NAME, SBML_Constants.SBML_HEADLINE + ": Name");
		AttributeHelper.setNiceId(SBML_Constants.INITIAL_AMOUNT, SBML_Constants.SBML_HEADLINE + ": Initial Amount");
		...
		AttributeHelper.setNiceId(SBML_Constants.SPECIES_CONSTANT, SBML_Constants.SBML_HEADLINE + ": Constant");
		AttributeHelper.setNiceId(SBML_Constants.SPECIES_CONVERSION_FACTOR,
				SBML_Constants.SBML_HEADLINE + ": Conversion Faktor");
		AttributeHelper.setNiceId(SBML_Constants.SPECIES_META_ID, SBML_Constants.SBML_HEADLINE + ": Meta ID");
