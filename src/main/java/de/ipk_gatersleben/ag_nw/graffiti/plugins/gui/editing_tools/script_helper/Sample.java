...
public class Sample implements SampleInterface {
	 ...
	 * substances. If this id and additionally the replicate ID matches, two values
	 * from two substances may be comparable.
	 * 
	...
	public void setDataOfChildElement(Element childElement) {
		if (childElement.getName().equals("average")) {
			...
			if (s.setData(childElement))
				sampleAverage = s;
		} else if (childElement.getName().equals("data")) {
