...
public class TranspathReaction extends TranspathEntity {
	...
	private Node getGraphNode(Graph g, String clusterID, HashMap<String, Node> graphElementId2graphNode) {
		...
		nh.setSize(10, 10);
		nh.setTooltip("Description: " + DESCRIPTION + ", Reversible: " + REVERSIBLE + ", Quality: " + QUALITY
				+ ", Comment: " + COMMENT);
	 ...
	 * MO000016681 MO000038630 PA000015142 PA000015147 PA000015158 PA000014438
	 * PA000014219 PA000014221 TFPA23825 CH000000622 CH000000724
	 */
}
