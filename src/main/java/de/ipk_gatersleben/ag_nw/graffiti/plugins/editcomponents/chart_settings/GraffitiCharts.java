...
public enum GraffitiCharts implements ChartComponent {
	...
	LINE("chart2d_type1", "Line Chart", "line"), BAR("chart2d_type2", "Bar Chart", "bar"), BAR_FLAT("chart2d_type3",
			"Bar Chart (flat)", "bar_flat"), PIE("chart2d_type4", "Pie Chart", "piechart"), PIE3D("chart2d_type5",
					"Pie Chart (skewed)", "piechart3d"), HEATMAP("heatmap", null, "heatmap"), HIDDEN("hidden", "Hidden",
							null), AUTOMATIC("auto", "Automatic", "automatic"), LEGEND_ONLY("legend", "Legend", null);
