...
public class DataMappingId implements Comparable<DataMappingId> {
	...
	public static DataMappingId getEmptyDataMappingWithoutReplicateInformation(int seriesId, String expName,
			String seriesName, String species, String genotype, String rowId, String timeP, String timeU) {
