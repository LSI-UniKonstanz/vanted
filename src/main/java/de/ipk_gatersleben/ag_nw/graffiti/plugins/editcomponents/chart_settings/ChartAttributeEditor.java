...
public class ChartAttributeEditor extends AbstractValueEditComponent {
	...
	public void setEditFieldValue() {
		if (showEmpty) {
			...
			// jComboBoxChartType.setSelectedIndex(2);
			// if
			// (displayable.getValue().equals(XMLAttribute.nodeTypeChart2D_type3_bar_flat))
			// jComboBoxChartType.setSelectedIndex(3);
			// // if
			// (displayable.getValue().equals(IPKnodeComponent.nodeTypeChart_legend_only))
			// // jComboBoxChartType.setSelectedIndex(4);
			...
			// jComboBoxChartType.setSelectedIndex(5);
			// if
			// (displayable.getValue().equals(XMLAttribute.nodeTypeChart2D_type6_heatmap))
			// jComboBoxChartType.setSelectedIndex(6);
