...
public class TreeContainer {
	...
	public TreeContainer(LinkedList<?> treeMap, HashMap<Integer, Double> depthOffset, HashMap<Node, Integer> bfsNum,
	...
	public TreeContainer(HashMap<Node, Integer> bfsNum, HashMap<Integer, Double> maxNodeHeight, HashSet<Edge> edges) {
		this.bfsNum = bfsNum;
		this.maxNodeHeight = maxNodeHeight;
		this.edges = edges;
	}

	public TreeContainer(HashMap<Integer, Double> depthOffset, HashMap<Node, Integer> bfsNum,
			HashMap<Integer, Double> maxNodeHeight, HashMap<Node, Integer> bfsNumUpsideDown) {
		this.depthOffset = depthOffset;
		this.bfsNum = bfsNum;
		this.maxNodeHeight = maxNodeHeight;
