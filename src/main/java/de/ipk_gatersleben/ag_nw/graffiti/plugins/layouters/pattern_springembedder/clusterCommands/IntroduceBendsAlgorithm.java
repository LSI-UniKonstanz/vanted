...
public class IntroduceBendsAlgorithm extends AbstractAlgorithm {
	...
	public void execute() {
		...
		GraphHelper.introduceNewBends(graph, workEdges, minPercent, edgeShape, (lineStyle == 3 ? 2 : 1),
				massCenterFromSelection, getName(), true);
		// if (maxDistance>0) {
		...
		// GraphHelper.introduceNewBends(getSubset(circle, workNodesCopy), minPercent,
		// edgeShape, (lineStyle==3 ? 2 : 1), true);
		// for (Edge del : circle) {
