...
public class TranspathMolecule extends TranspathEntity {
	...
	public Node getGraphNode(Graph g, String clusterID, HashMap<String, Node> graphElementId2graphNode) {
		...
		Node n = g
				.addNode(AttributeHelper.getDefaultGraphicsAttributeForNode(Math.random() * 500, Math.random() * 500));
		...
		nh.setSize(20, 20);
		nh.setTooltip(
				"Type: " + TYPE + ", Super/Sub-Family: " + SUPERFAMILY + "/" + SUBFAMILY + ", Comment: " + COMMENT);
		...
		/*
		 * public String ID, NAME, ALIASES, TYPE, FIRST, LAST, CLASS, SUPERFAMILY,
		 * SUBFAMILY, RKOUT, RKIN, CATALYZES, INHIBITS, COMMENT, REFERENCE, GENBANKID,
		 * ENSEMBLID, ENTREZGENEID, INTERPRODESCRIPTION, INTERPROID, OMIMID, PDBID,
		 * PFAMID, PIRID, PROSITEID, REFSEQID, REFSEQPID, UNIGENEID, UNIPROTACCESSION,
		 * GOTYPE, GODESCRIPTION, GOACCESSION, OTHERACCESION, OTHERGENOMICACCESION;
		 */
		return n;
	}
	 ...
	 * subunit orthofamily enzymes; transferases EC 2; transferases EC 2.7;
	 * phosphotransferases EC 2.7.1; protein serine/threonine kinases; AGC kinases
	 * MO000019596 MO000020657 MO000021790 MO000021807 MO000033328 MO000033604
	 * MO000034581 MO000035255 MO000035257 XN000000509 XN000000728 XN000000968
	 * XN000001405 XN000001552 XN000001715 XN000003642 XN000004354 XN000005173
	 * XN000005174 XN000005176 XN000005182 XN000005616 XN000006622 XN000015246
	 * XN000015281 XN000015486 XN000015628 XN000016709 XN000016728 XN000017434
	 * XN000017692 XN000017695 XN000017964 XN000021885 XN000022739 XN000026992
	 * XN000026996 XN000026999 XN000027342 XN000033827 XN000000516 XN000000539
	 * XN000001626 XN000015487 XN000000309 XN000000386 XN000000390 XN000023917
