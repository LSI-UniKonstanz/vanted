...
//		}
	...
	public void setNonRDFAnnotationProduct(Edge reactionEdge,
			XMLNode xmlNode) {
		AttributeHelper.setAttribute(reactionEdge, SBML_Constants.SBML,
				SBML_Constants.PRODUCT_NON_RDF_ANNOTATION, xmlNode);
	}
	
	public XMLNode getNonRDFAnnotationProduct(Edge edge) {
		if (isSetAnnotationProduct(edge)) {
			return (XMLNode) attWriter.getAttribute(edge,
	...
	public void setNonRDFAnnotationModifier(Edge reactionEdge,
			XMLNode xmlNode) {
		AttributeHelper.setAttribute(reactionEdge, SBML_Constants.SBML,
				SBML_Constants.MODIFIER_NON_RDF_ANNOTATION, xmlNode);
	}
	...
	public void setNonRDFAnnotationReactant(Edge reactionEdge,
			XMLNode xmlNode) {
		AttributeHelper.setAttribute(reactionEdge, SBML_Constants.SBML,
				SBML_Constants.REACTANT_NON_RDF_ANNOTATION, xmlNode);
	}
