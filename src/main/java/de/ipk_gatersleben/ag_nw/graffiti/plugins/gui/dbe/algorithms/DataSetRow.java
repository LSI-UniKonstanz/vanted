...
public class DataSetRow {
	...
	public String rowLabel, experimentName, substanceName, mapping, species, genotype, treatment, timeS, timeUnit, unit;
	public Double value;
	
	public DataSetRow(String rowLabel, String experimentName, String substanceName, String mapping, String species,
			String genotype, String treatment, int seriesId, String timeS, String timeUnit, int replicateID,
	...
	public String toString() {
		return rowLabel + "\t" + "\"" + experimentName + "\"" + "\t" + "\"" + substanceName + "\"" + "\t" + mapping
				+ "\t" + "\"" + species + "\"" + "\t" + "\"" + genotype + "\"" + "\t" + "\"" + treatment + "\"" + "\t"
				+ "\"" + seriesId + "\"" + "\t" + timeS + "\t" + timeUnit + "\t" + replicateID + "\t"
