...
public class MetatoolWriter implements OutputSerializer {
	...
	public void write(OutputStream stream, Graph g) throws IOException {
		...
		if (wronmgmetabolites)
			ErrorMsg.addErrorMessage(
					"<html>Some products or reactants not well defined! It is inevitable to assign SBML-roles to the edges.<br>"
	...
	private boolean isEnzyme(Node nd) {
		...
		// Vanted may have nodes without a shape-attribute, which will be visualised as
		// rectangles
