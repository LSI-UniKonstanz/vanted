...
public class UDegradation extends UtilitySuperClassToGraph {
	/**
	 ...
	 */
	public static void addAttributesToNode(GraphElement elem, Degradation i)
			throws IllegalArgumentException, IllegalAccessException, InvocationTargetException {
		// first set label to node
		setLabels(elem, i);
		elem.setString(Messages.getString("UtilitySuperClassToGraph.127"), //$NON-NLS-1$
				Messages.getString("UtilitySuperClassToGraph.147")); //$NON-NLS-1$
		// set attribute paths
