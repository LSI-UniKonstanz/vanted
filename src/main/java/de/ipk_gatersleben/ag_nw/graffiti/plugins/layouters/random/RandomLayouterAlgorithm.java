...
public class RandomLayouterAlgorithm extends AbstractAlgorithm {
	...
	String[] randomizeOptions = { "Randomize using current available screen area",
	...
	public Parameter[] getParameters() {
		...
		ObjectListParameter optionsList = new ObjectListParameter(randomizeOptions[0], "Use Area",
				"<html>Selecting one of the options changes behaviour for layouting the nodes<br/>"
						+ "for a given area",
				randomizeOptions);
		
		return new Parameter[] { optionsList };
	}
	...
	public void execute() {
		...
		} else if (selectedRandomizeOptions.equals(randomizeOptions[1])) {
