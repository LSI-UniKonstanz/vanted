...
public class LVL3ModelConverter {
	 ...
	 * find related ones and add them
	 * 
	 * @param inters
	 * @param originalModel
	 */
	private void mayLoadAdditionalControls(Set<Interaction> inters, Model originalModel) {
		int answer = JOptionPane.showOptionDialog(JOptionPane.getRootFrame().getFocusOwner(),
				"Do you want to import corresponding BioPax-Control-Elements into the Graph too?",
				"Please choose an option!", JOptionPane.YES_NO_OPTION, JOptionPane.QUESTION_MESSAGE, null,
	...
	private void getSubProcesses(
			Set<de.ipk_gatersleben.ag_nw.graffiti.plugins.ios.biopax.lvl3interactions.MyPathWay> set,
	 ...
	 * @throws InvocationTargetException
	 */
	private void writeInteractionsToGraph(Set<Interaction> inters)
			throws IllegalArgumentException, IllegalAccessException, InvocationTargetException {
		if (debug)
