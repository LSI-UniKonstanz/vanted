...
public class XWGSerializer extends AbstractOutputSerializer {
	...
	private String getPosition(Node n) {
		...
		String x, y, z;
		x = AttributeHelper.formatNumber(p.getX() / 10d, "#.#");
		y = AttributeHelper.formatNumber(p.getY() / 10d, "#.#");
		...
		z = AttributeHelper.formatNumber(zz / 10d, "#.#");
	...
	private String getColor(GraphElement ge) {
		...
		String r, g, b;
		r = AttributeHelper.formatNumber(c.getRed() / 255d, "#.#");
		g = AttributeHelper.formatNumber(c.getGreen() / 255d, "#.#");
