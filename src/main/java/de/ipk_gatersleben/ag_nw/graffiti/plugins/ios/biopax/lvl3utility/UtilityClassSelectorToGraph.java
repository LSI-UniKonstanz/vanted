...
public class UtilityClassSelectorToGraph {
	...
	public static void chooseClassToPutAttributesToNodes(GraphElement elem, Object i) {
		try {
			...
			} else if (i instanceof Transport) {
			...
			} else if (i instanceof TemplateReaction) {
				UTemplateReaction.addAttributesToNode(elem, (TemplateReaction) i);
			} else if (i instanceof Catalysis) {
			...
			} else if (i instanceof Conversion && !(i instanceof BiochemicalReaction) && !(i instanceof ComplexAssembly)
					&& !(i instanceof Transport) && !(i instanceof Degradation)
					&& !(i instanceof TransportWithBiochemicalReaction)) {
				UConversion.addAttributesToNode(elem, (Conversion) i);
			} else if (i instanceof Control && !(i instanceof Catalysis) && !(i instanceof Modulation)
					&& !(i instanceof TemplateReactionRegulation)) {
				UControl.addAttributesToNode(elem, (Control) i);
			} else if (i instanceof Pathway) {
