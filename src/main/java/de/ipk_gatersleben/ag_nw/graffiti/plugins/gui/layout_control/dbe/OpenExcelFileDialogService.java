...
/**
 * @author Christian Klukas (c) 2004, 2009 IPK-Gatersleben
 */
public class OpenExcelFileDialogService implements HelperClass {
	...
	public static final String[] EXCEL_OR_BINARY_EXTENSION = new String[] { ".XLSX", ".XLS", ".CSV", ".BIN", ".DAT",
			".TXT", ".LIST" };
	...
	public static final String[] EXCELFILE_EXTENSIONS = new String[] { ".XLSX", ".XLS", ".CSV", ".TXT", ".LIST",
			".DAT" };
	...
	public static Collection<File> getAffyOrAgilAnnotationFiles() {
		return OpenFileDialogService.getFiles(new String[] { ".ANNOT.CSV", ".XLSX", ".XLS", ".CSV", ".TXT" },
