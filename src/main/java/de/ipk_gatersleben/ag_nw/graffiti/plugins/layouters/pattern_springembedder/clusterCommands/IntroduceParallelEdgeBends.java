...
//			MainFrame.showMessage(changed.size() + " edges have been processed and selected.", MessageType.INFO);
	...
	private void parallelEdgesFromEdgeSelection(Collection<Edge> edges) {
		...
		for(Edge curEdge : edges) {
			...
			String combinedIdForward = Integer.toString(sourceNode.hashCode()) + Integer.toString(targetNode.hashCode());
			String combinedIdBackward = Integer.toString(targetNode.hashCode()) + Integer.toString(sourceNode.hashCode());
