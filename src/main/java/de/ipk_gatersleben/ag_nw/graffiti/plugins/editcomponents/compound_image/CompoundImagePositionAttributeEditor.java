...
public class CompoundImagePositionAttributeEditor extends AbstractValueEditComponent {
	...
	public static String[] getPosiblePositions(boolean includeEmpty) {
		if (includeEmpty)
			return new String[] { EMPTY_STRING, GraphicAttributeConstants.CENTERED,
					GraphicAttributeConstants.CENTERED_FIT, GraphicAttributeConstants.LEFT,
					GraphicAttributeConstants.RIGHT, GraphicAttributeConstants.ABOVE, GraphicAttributeConstants.BELOW,
					GraphicAttributeConstants.AUTO_OUTSIDE, GraphicAttributeConstants.HIDDEN };
		else
			return new String[] { GraphicAttributeConstants.CENTERED, GraphicAttributeConstants.LEFT,
					GraphicAttributeConstants.RIGHT, GraphicAttributeConstants.ABOVE, GraphicAttributeConstants.BELOW,
					GraphicAttributeConstants.AUTO_OUTSIDE, GraphicAttributeConstants.HIDDEN };
