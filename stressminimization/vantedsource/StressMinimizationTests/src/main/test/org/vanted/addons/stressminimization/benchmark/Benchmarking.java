...
public final class Benchmarking {
	...
	/**
	 * Executes a benchmark of the first argument.
	 * The benchmark is executed rounds times with warmupRounds
	 * executions before time measurement.
	 * The prepare action is performed before each execution
	 * but execution time is not measured.
	 * @param action The action whose execution time shawl be measured
	 * @param prepare A preperation action. Executed before each execution of action. Use this action to reset any data / layout used by action.
	 * @param warmupRounds number of executions of action before time measurements
	 * @param rounds number of executions for which execution time will be measured
