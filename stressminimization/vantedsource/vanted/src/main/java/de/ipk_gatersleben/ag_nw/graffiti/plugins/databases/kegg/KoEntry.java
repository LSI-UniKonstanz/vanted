...
public class KoEntry implements Comparable<KoEntry> {
	...
	/**
	 * mapping between BriteEntry name (KO, Module, Gene) to Brite Entry, which is
	 * the leaf node. To get the full hierarchy just go up by calling getParent() on
	 * each briteentry object
	 */
