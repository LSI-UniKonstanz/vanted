...
public class IPKDefaultView extends DBE_EditorPluginAdapter {
	...
	public IPKDefaultView() {
		...
		this.attributeDescriptions = new AttributeDescription[] {
				...
				new AttributeDescription(GraphicAttributeConstants.GRADIENT, GradientFillAttribute.class, null, true,
						true, null),
				new AttributeDescription(GraphicAttributeConstants.THICKNESS, ThicknessAttribute.class, null, false,
						true, null),
				new AttributeDescription(".graphics.docking.source", SourceDockingAttribute.class, null, false, true,
						null),
