...
public class KeggExpressionDatapoint {
	...
	public KeggExpressionDatapoint(String geneId, Double cSig, Double cBgk, Double tSig, Double tBgk, Double c,
			Double t, Double optX, Double optY, String optRawTextFileInformationSignalQualityPMA) {
