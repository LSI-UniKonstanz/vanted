...
public class Aus extends java.io.OutputStream {
	...
	/**
	 * Insert the method's description here. Creation date: (14.12.2001 13:57:31)
	 */
	public Aus() {
	...
	public static void a(String text, double[][] o) {
		...
		for (int i = 0; i < o.length; i++) {
			...
			output("L�nge der 1-" + (i + 1) + ". Dimension: " + String.valueOf(o[i].length), "          ",
					getStartingMethod());

			for (int j = 0; j < o[i].length; j++) {

				output("Dimension 1-" + (i + 1) + "   Wert " + (j + 1) + ":   ", String.valueOf(o[i][j]),
						getStartingMethod());
	...
	public static void ac(String text, double[][] o) {
		...
		for (int i = 0; i < o.length; i++) {
			...
			outputc("L�nge der 1-" + (i + 1) + ". Dimension: " + String.valueOf(o[i].length), "          ",
					getStartingMethod());

			for (int j = 0; j < o[i].length; j++) {

				outputc("Dimension 1-" + (i + 1) + "   Wert " + (j + 1) + ":   ", String.valueOf(o[i][j]),
						getStartingMethod());
	...
	/**
	 * Insert the method's description here. Creation date: (18.12.2001 16:10:15)
	 */
	...
	/**
	 * Insert the method's description here. Creation date: (18.12.2001 15:40:36)
	 * 
	 * @param bw
	...
	/**
	 * Insert the method's description here. Creation date: (12.01.02 17:40:06)
	 * 
	...
	/**
	 * Insert the method's description here. Creation date: (19.12.2001 20:10:21)
	 * 
	 * @param str
	 *            java.lang.String
	 */
	...
	/**
	 * Insert the method's description here. Creation date: (18.12.2001 16:07:32)
	 */
	...
	/**
	 * Insert the method's description here. Creation date: (14.12.2001 14:26:12)
	 * 
	 * @param i
	 *            int
	 */
