...
public enum LabelFrameSetting {
	NO_FRAME, RECTANGLE, ELLIPSE, CAPSULE, RECTANGLE_BOTTOM_ROUND, RECTANGLE_ROUNDED, RECTANGLE_CORNER_CUT, CIRCLE_HALF_FILLED, CIRCLE_FILLED, CIRCLE, HEXAGON, PIN, SIDE_LINES;
