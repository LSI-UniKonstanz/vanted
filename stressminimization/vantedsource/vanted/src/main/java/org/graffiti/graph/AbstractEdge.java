...
public abstract class AbstractEdge extends AbstractGraphElement implements Edge {
	 ...
	 * 
	 * @param graph
	 *            the <code>Graph</code> the new <code>AbstractEdge</code> instance
	 *            shall belong to.
	 * @param coll
	 ...
	 * Informs the ListenerManager that the direction has been modified.
	 * 
	 * @param directed
	 ...
	 * current <code>Edge</code>. Informs the ListenerManager about the change.
	 * 
	 * @param source
	...
	/**
	 * Swaps source and target of the edge. Informs the listtenerManager about the
	 * change.
	 */
	public void reverse() {
	 ...
	 *                if source cannot be found in the <code>Graph</code>.
	 */
	protected abstract void doSetSource(Node source) throws GraphElementNotFoundException;

	/**
	 * Sets the target of the current <code>Edge</code> to target. Target must be
	 * contained in the same <code>Graph</code> as the <code>Edge</code>.
	 * 
	 * @param target
	 *            the target to be set.
	 * @exception GraphElementNotFoundException
	 *                if the target cannot be found in the <code>Graph</code>.
	 */
	protected abstract void doSetTarget(Node target) throws GraphElementNotFoundException;
}
