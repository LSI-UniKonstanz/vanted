...
public class NodeBorder extends AbstractBorder {
	...
	public void paintBorder(Component c, Graphics g, int x, int y, int width, int height) {
		...
		// int h_ib = (int)Math.ceil(height/((Graphics2D)cg).getTransform().getScaleY()
		// - insets.bottom);
		// cg.setClip(0, h_ib, width, insets.bottom);
		// Point p = new Point(0, h_ib);
		cg.fillRect(0, height - zoomedBorderWidth, zoomedBorderWidth, zoomedBorderWidth);
		...
		// insets.bottom));
		cg.fillRect(width - zoomedBorderWidth, height - zoomedBorderWidth, zoomedBorderWidth, zoomedBorderWidth);
