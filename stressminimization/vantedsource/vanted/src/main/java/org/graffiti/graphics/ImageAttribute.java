...
public class ImageAttribute extends HashMapAttribute implements GraphicAttributeConstants {
	...
	public void setCollection(Map<String, Attribute> attrs) {
		if (attrs.keySet().contains(TILED) && attrs.keySet().contains(MAXIMIZE) && attrs.keySet().contains(IMAGE)
	...
	protected void doSetValue(Object v) throws IllegalArgumentException {
		...
		try {
			...
			this.reference = (StringAttribute) StringAttribute.getTypedStringAttribute("reference",
					value.getReference());
