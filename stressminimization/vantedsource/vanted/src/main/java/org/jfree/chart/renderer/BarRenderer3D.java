 ...
 * $Id: BarRenderer3D.java,v 1.3 2010/12/14 07:02:04 morla Exp $
 * Changes
 * -------
...
public class BarRenderer3D extends BarRenderer implements Effect3D, Cloneable, PublicCloneable, Serializable {
	...
	public void drawBackground(Graphics2D g2, CategoryPlot plot, Rectangle2D dataArea) {
		...
		if (backgroundImage != null) {
			...
			g2.setComposite(AlphaComposite.getInstance(AlphaComposite.SRC, plot.getBackgroundAlpha()));
	...
	public void drawItem(Graphics2D g2, CategoryItemRendererState state, Rectangle2D dataArea, CategoryPlot plot,
		...
		if (state.getInfo() != null) {
			...
			if (entities != null) {
				...
				CategoryItemEntity entity = new CategoryItemEntity(barOutline, tip, url, dataset, row,
