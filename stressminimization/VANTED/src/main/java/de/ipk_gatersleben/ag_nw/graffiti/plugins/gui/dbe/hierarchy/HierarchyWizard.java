...
public class HierarchyWizard extends AbstractAlgorithm {
	...
	public void execute() {
		...
		Runnable bt = new Runnable() {
			...
			public void run() {
				...
				GravistoService.getInstance().runAlgorithm(new CreateFuncatGraphAlgorithm(), g, new Selection(""),
				...
				// new DotLayoutAlgorithm(), g, new Selection(""),
				// HierarchyWizard.this.getActionEvent());
				// GravistoService.getInstance().runAlgorithm(
	...
	public String getDescription() {
		return "<html>Enrichment Wizard:<ol>" + "<li>Calculation of mapping sample average value"
				...
				+ "<li>Construction of hierarchy tree" + "<li>Hide data nodes" + "<li>Layout tree"
