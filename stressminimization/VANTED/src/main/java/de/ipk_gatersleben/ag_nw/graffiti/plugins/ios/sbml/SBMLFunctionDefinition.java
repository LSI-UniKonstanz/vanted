...
public class SBMLFunctionDefinition {
	...
	public ASTNode getFunction() {
		if (isSetFunction()) {
			try {
				String string = new StringBuffer(internHeadline).append(SBML_Constants.FUNCTION_DEFINITION_FUNCTION)
						.toString();
				String string2 = (String) attWriter.getAttribute(g, internHeadline, string);
