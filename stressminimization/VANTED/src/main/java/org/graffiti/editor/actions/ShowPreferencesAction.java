...
public class ShowPreferencesAction extends GraffitiAction {
	...
	public void actionPerformed(ActionEvent e) {
		 ...
		 * 
		 * dialog.setPreferredSize(new Dimension(450, 600)); JScrollPane scrollpane =
		 * new JScrollPane(getSettings()); dialog.getContentPane().setLayout(new
		 * BorderLayout()); dialog.getContentPane().add(scrollpane,
		 * BorderLayout.CENTER); dialog.pack(); dialog.setLocationRelativeTo(mainFrame);
