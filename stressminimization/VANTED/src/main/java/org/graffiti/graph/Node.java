...
public interface Node extends GraphElement {
	 ...
	 * less than the number returned by <code>getInDegree()</code>, due to the fact
	 ...
	 * target of either an ingoing or an outgoing or an undirected
	 * <code>Edge</code>.
	 * 
	 ...
	 * <code>Node</code>. A neighbor <code>Node</code> is either the source or the
	 * target of either an ingoing or outgoing or undirected <code>Edge</code>.
	 * 
	 ...
	 * that the number of elements returned by this function might be less than the
	 * number returned by <code>getOutDegree()</code>, due to the fact that multiple
	 * edges between the same two nodes are possible but the corresponding
	 * <code>Node</code> is only inserted once.
	 * 
	 * @return a collection containing all the neighbor nodes of the current
	 ...
	 * the <code>Node</code>.
	 * 
	 * @return a collection containing the undirected ingoing and outgoing edges of
	 *         the <code>Node</code>.
	 */
	 ...
	 * 
	 * @return a collection containing all the neighbors which are connected to the
	 *         current <code>Node</code> by an undirected <code>Edge</code>.
	 */
	 ...
	 * 
	 * @return Returns the number of incoming directed edges + outgooing directed
	 *         edges + number of connected undirected edges.
	 */
