 ...
 * Tim Bardzil;
 * $Id: BoxAndWhiskerRenderer.java,v 1.2 2010/12/14 07:02:04 morla Exp $
 * Changes
 * -------
...
public class BoxAndWhiskerRenderer extends AbstractCategoryItemRenderer
	...
	/**
	 * Returns the item margin. This is a percentage of the available space that is
	 * allocated to the space between items in the chart.
	 * 
	 * @return The margin.
	 */
	...
	public void drawHorizontalItem(Graphics2D g2, CategoryItemRendererState state, Rectangle2D dataArea,
		...
		if (seriesCount > 1) {
			...
			// offset the start of the box if the box width is smaller than the category
			// width
