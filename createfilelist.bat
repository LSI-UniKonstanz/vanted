...
echo Core...
dir *.xml /s /b > plugins1.txt 2> nul
cd ..\..\..

cd Graffiti_Editor\build\classes
echo Editor...
dir *.xml /s /b > plugins2.txt 2> nul
cd ..\..\..

cd Graffiti_Plugins\build\classes
echo Plugins...
dir *.xml /s /b > plugins3.txt 2> nul
cd ..\..\..
...
dir *.xml /s /b > plugins4.txt 2> nul
...
echo "./log4j.xml" >> plugins_exclude.txt
