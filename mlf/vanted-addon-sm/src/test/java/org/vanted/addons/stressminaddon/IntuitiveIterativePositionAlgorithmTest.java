...
public class IntuitiveIterativePositionAlgorithmTest {
    ...
    public void nextIterationSquare() {
        ...
        List<Vector2d> position = alg.nextIteration(GRAPH_1_NODES, GRAPH_1_POSITIONS, GRAPH_1_DISTANCES, weights);
    ...
    /**
     * Test the method nextIteration on a Graph where every Node is at one Position.
     * @author Rene
     */
    @Test
    public void nextIterationOnePosition() {
        ...
        List<Vector2d> position = alg.nextIteration(GRAPH_COLLAPSED_NODES_NODES, GRAPH_1_POSITIONS, GRAPH_COLLAPSED_DISTANCES, weights);
        Vector2d[] expected = new Vector2d[]{
                new Vector2d(0.9539762708474337, 0.9539762708474337),
                new Vector2d(0.9530573762510635, 2.025139164383653),
                new Vector2d(2.0199185207071757, 2.041414027985703),
