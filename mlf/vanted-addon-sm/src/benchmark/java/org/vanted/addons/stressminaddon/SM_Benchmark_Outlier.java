...
/**
 * Run benchmarks for outlier(looking how often a local stressminimum appeared) in VANTED.
 * @author Rene
 */
public class SM_Benchmark_Outlier {
     ...
     */
    private final static int REPEAT_TIMES = 100;
    private final static String getPath = "benchmark/java/test_graphs/OutlierGraphs/";
    private final static String outPath = "benchmark/java/test_graphs/OutlierGraphs/output_Outlier/";
    private final static String csv_singleName = "csv_singleSteps_Outlier_Graphs";
    private final static String csv_averageName = "csv_average_Outlier_Graphs";
    ...
    public void benchmark() throws InterruptedException{
        ...
        String[] graphen = {"sierpinski_04.gml","3elt.gml","sierpinski_07.gml","add20.gml"};
