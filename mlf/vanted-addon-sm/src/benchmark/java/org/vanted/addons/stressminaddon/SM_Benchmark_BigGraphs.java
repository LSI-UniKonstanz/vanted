...
/**
 * Run benchmarks for BigGraph in VANTED.
 * @author Rene
 */

public class SM_Benchmark_BigGraphs {

    /**
     *Sets the parameter for the test
     */
    private final static int REPEAT_TIMES = 3;
    private final static String getPath = "benchmark/java/test_graphs/BigGraphs/";
    private final static String outPath = "benchmark/java/test_graphs/BigGraphs/output_BigGraphs/";
    private final static String csv_singleName = "csv_singleSteps_BigGraphs";
    private final static String csv_averageName = "csv_average_BigGraphs";
    ...
    public void benchmark() throws InterruptedException{
        ...
        String[] graphen = {"3elt.gml","4elt.gml","add20.gml","add32.gml","crack.gml","cs4.gml"};
            ...
            for (int graphIndex = 0; graphIndex < graphen.length; graphIndex++) {
                ...
                try {
                    ...
                    for (int repeat = 0; repeat < REPEAT_TIMES; repeat++) {
                        ...
                        if (graph.getNumberOfNodes() > 1500) {
