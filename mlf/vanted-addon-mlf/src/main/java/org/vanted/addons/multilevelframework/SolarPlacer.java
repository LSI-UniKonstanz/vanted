...
public class SolarPlacer implements Placer {
    ...
    public void reduceCoarseningLevel(MultilevelGraph multilevelGraph) {
        ...
        @SuppressWarnings("unchecked") final Set<Node> allPlanets = (Set<Node>) getElement(top, SolarMerger.PLANETS_KEY);
        @SuppressWarnings("unchecked") final Set<Node> allMoons = (Set<Node>) getElement(top, SolarMerger.MOONS_KEY);
        @SuppressWarnings("unchecked") final HashMap<Node, Set<Node>> sunToPlanets = (HashMap<Node, Set<Node>>) getElement(top,
                SolarMerger.SUN_TO_PLANETS_KEY);
        @SuppressWarnings("unchecked") final HashMap<Node, Set<Node>> planetToMoons = (HashMap<Node, Set<Node>>) getElement(top,
