...
public class MLFParamModel {
    ...
    public class LayoutAlgGroup extends JComponent {
        ...
        private final Map<String, LayoutAlgorithmWrapper> layoutAlgorithms =
                LayoutAlgorithmWrapper.getLayoutAlgorithms();
        ...
        private void removeControlButtons(JPanel algOptionsContainer) {
            Container algOptions =
                    ((Container) (
                            ((Container)
                                    ((Container)
                                            algOptionsContainer.getComponent(0)
                                    ).getComponent(0)
                            ).getComponent(0)
                    ));
    ...
    public class MergerGroup extends JComponent {
        ...
        MergerGroup() {
            ...
            for (Merger merger : MultilevelFrameworkLayouter.getMergers()) {
    ...
    public class PlacerGroup extends JComponent {
        ...
        PlacerGroup() {
            ...
            for (Placer placer : MultilevelFrameworkLayouter.getPlacers()) {
