...
public interface SOMdataEntry {
	 ...
	 *         normalize the data column wise! This means, e.g. all values for time
	 *         point 1 will be collected and then normalized, thus from day to day a
	 *         different normalization is performed. This is useful while analyzing
	 *         independent data points. For time series data this is clearly not a
	 *         good idea, in this case the data should be supplied normalized and
