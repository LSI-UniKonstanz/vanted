 ...
 * $Id: SegmentedHighLowChartDemo.java,v 1.2 2010/12/14 07:02:01 morla Exp $
 * Changes
 * -------
...
public class SegmentedHighLowChartDemo extends ApplicationFrame {
	...
	public SegmentedHighLowChartDemo(final String title, final boolean useSegmentedAxis, final int timelineType) {
		...
		final HighLowDataset dataset = DemoDatasetFactory.createSegmentedHighLowDataset(timeline, cal.getTime());
