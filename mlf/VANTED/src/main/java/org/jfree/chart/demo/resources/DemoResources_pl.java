 ...
 * $Id: DemoResources_pl.java,v 1.3 2010/12/14 09:27:16 morla Exp $
 * Changes
 * -------
...
public class DemoResources_pl extends ListResourceBundle {
	...
	private static final Object[][] CONTENTS = {
			...
			{ "tab.bar", "Wykresy Kolumnowe i S\u0142upkowe" }, { "tab.pie", "Wykresy Ko\u0142owe" },
			{ "tab.xy", "Wykresy XY" }, { "tab.time", "Wykresy Liniowe" }, { "tab.other", "Wykresy Inne" },
			{ "tab.test", "Wykresy Testowe" }, { "tab.combined", "Wykresy Niestandardowe" },
			...
			{ "chart9.description",
					"Wykres punktowy, z punktami danych po\u0142\u0105czonymi "
			...
			{ "chart11.description",
					"Wykres liniowy - wy\u015bwietla trend w czasie lub dla r\u00f3\u017cnych"
							+ " kategorii danych XY. " + "O\u015b pionowa jest wyskalowana logarytmicznie." },
			...
			{ "chart18.description",
					"Wykres wy\u015bwielta linie i/lub kszta\u0142ty, przedstawiaj\u0105ce dane z "
							+ "CategoryDataset. " + "Ponadto ilustruje u\u017cycie obrazka w tle wykresu oraz "
							+ "przezroczysto\u015bci alpha " + "na rysunku." },

			{ "chart19.title", "Pionowy XY kolumnowy: " },
			{ "chart19.description", "Wykres prezentuje pionowe s\u0142upki oparte na " + "IntervalXYDataset." },

			{ "chart20.title", "Puste dane: " }, { "chart20.description", "Wykres dla braku danych (null dataset)." },

			{ "chart21.title", "Dane zero: " }, { "chart21.description", "Wykres dla serii zer w danych." },
			...
			{ "chart24.description",
					"Dynamiczny (rysowany na bie\u017c\u0105co) wykres do testowania "
			...
			{ "chart27.description",
					"Wy\u015bwietla 4 r\u00f3\u017cne wykresy umo\u017cliwiaj�ce por\u00f3wnanie danych "
							+ "w pionie na jednym rysunku " + "dla XY, liniowe /czasowe oraz kolumn pionowych XY." },
			...
			{ "bar.horizontal.title", "Poziomy wykres s\u0142upkowy" }, { "bar.horizontal.domain", "Kategorie" },
			{ "bar.horizontal.range", "Warto\u015bci" },

			{ "bar.horizontal-stacked.title", "Poziomy, skumulowany wykres s\u0142upkowy" },
			{ "bar.horizontal-stacked.domain", "Kategorie" }, { "bar.horizontal-stacked.range", "Warto\u015bci" },

			{ "bar.vertical.title", "Pionowy wykres kolumnowy" }, { "bar.vertical.domain", "Kategorie" },
			{ "bar.vertical.range", "Warto\u015bci" },

			{ "bar.vertical3D.title", "Pionowy wykres kolumnowy z efektem 3-W" },
			{ "bar.vertical3D.domain", "Kategorie" }, { "bar.vertical3D.range", "Warto\u015bci" },

			{ "bar.vertical-stacked.title", "Pionowy, skumulowany wykres kolumnowy" },
			{ "bar.vertical-stacked.domain", "Kategorie" }, { "bar.vertical-stacked.range", "Warto\u015bci" },

			{ "bar.vertical-stacked3D.title", "Pionowy, skumulowany wykres kolumnowy z efektem 3-W" },
			{ "bar.vertical-stacked3D.domain", "Kategorie" }, { "bar.vertical-stacked3D.range", "Warto\u015bci" },

			{ "pie.pie1.title", "Wykres ko\u0142owy 1 - wysuni\u0119ty" },

			{ "pie.pie2.title", "Wykres ko\u0142owy 2 - tradycyjny" },

			{ "xyplot.sample1.title", "Wykres XY Punktowy" }, { "xyplot.sample1.domain", "X Warto\u015bci" },
			{ "xyplot.sample1.range", "Y Warto\u015bci" },

			{ "timeseries.sample1.title", "Wykres liniowy przebiegu kursu w czasie - 1" },
			{ "timeseries.sample1.subtitle", "Warto\u015bci PLN in JPY" }, { "timeseries.sample1.domain", "Data" },
			{ "timeseries.sample1.range", "CCY na z\u0142ot\u00f3wk\u0119" },
			{ "timeseries.sample1.copyright", "(C)opyright 2002, by Krzysztof Pa\u017a, PW" },

			{ "timeseries.sample2.title", "Liniowy 2" }, { "timeseries.sample2.domain", "Millisekundy" },
			{ "timeseries.sample2.range", "O\u015b logarytmiczna" }, { "timeseries.sample2.subtitle", "Millisekundy" },

			{ "timeseries.sample3.title", "Liniowy z ruchomym trendem u\u015brednionym" },
			{ "timeseries.sample3.domain", "Data" }, { "timeseries.sample3.range", "CCY na PLN" },
			...
			{ "timeseries.highlow.domain", "Data" }, { "timeseries.highlow.range", "Cena (PLN za udzia\u0142)" },
			...
			{ "timeseries.signal.title", "Wykres sygna\u0142owy" }, { "timeseries.signal.domain", "Data" },
			{ "timeseries.signal.range", "Cena (PLN za udzia\u0142)" },
			{ "timeseries.signal.subtitle", "Warto\u015b\u0107 akcji OPTIMUS S.A." },

			{ "other.wind.title", "Wykres wiatru" }, { "other.wind.domain", "O\u015b X" },
			{ "other.wind.range", "O\u015b Y" },

			{ "other.scatter.title", "Rozrzucony punktowy" }, { "other.scatter.domain", "O\u015b X" },
			{ "other.scatter.range", "O\u015b Y" },

			{ "other.line.title", "Liniowy" }, { "other.line.domain", "Kategoria" },
			{ "other.line.range", "Warto\u015b\u0107" },

			{ "other.xybar.title", "Liniowy kolumnowy" }, { "other.xybar.domain", "Data" },
			{ "other.xybar.range", "Warto\u015b\u0107" },

			{ "test.null.title", "Wykres XY (null data)" }, { "test.null.domain", "X" }, { "test.null.range", "Y" },

			{ "test.zero.title", "Wykres XY (zero data)" }, { "test.zero.domain", "O\u015b X" },
			{ "test.zero.range", "O\u015b Y" },

			{ "test.scroll.title", "Liniowy / Time Series" }, { "test.scroll.subtitle", "Warto\u015b\u0107 PLN" },
			{ "test.scroll.domain", "Data" }, { "test.scroll.range", "Warto\u015b\u0107" },

			{ "test.single.title", "Pojedyncza seria" }, { "test.single.subtitle1", "Podtytu\u0142 1" },
			{ "test.single.subtitle2", "Podtytu\u0142 2" }, { "test.single.domain", "Data" },
			{ "test.single.range", "Warto\u015b\u0107" },

			{ "test.dynamic.title", "Wykres Dynamiczny" }, { "test.dynamic.domain", "Domena" },
			...
			{ "combined.overlaid.domain", "Data" }, { "combined.overlaid.range", "OPTIMUS S.A." },
			...
			{ "combined.vertical.subtitle", "Cztery wykresy na jednym" }, { "combined.vertical.domain", "Data" },
			...
			{ "combined.combined-overlaid.subtitle",
					"XY, mnak\u0142adany (dwie TimeSeries) i nak\u0142adany " + "(Max/Min i TimeSeries)" },
			...
			{ "combined.dynamic.subtitle",
					"XY (seria 0), XY (seria 1), nak\u0142adany (obie serie) " + "oraz XY (obie serie)" },
