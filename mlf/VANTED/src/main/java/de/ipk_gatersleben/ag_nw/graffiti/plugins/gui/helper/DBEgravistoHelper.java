...
public class DBEgravistoHelper implements HelperClass {
	...
	static {
		...
		try {
			...
			// System.out.println("vanted version:"+DBE_GRAVISTO_VERSION_CODE+"
			// build:"+VANTED_BUILD+" date:"+VANTED_BUILDDATE);
		} catch (IOException e) {
			e.printStackTrace();
		}
	...
	public static String getPluginStatusText() {
		...
		DefaultPluginEntry te = GravistoService.getInstance()
				.getPluginInstanceFromPluginDescription("IPK Editing Tools");
